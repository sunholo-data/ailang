// Package protocol defines the stdlib-only contracts and wire helpers shared by
// AILANG protocol hosts. The dependency guarantee is enforced by
// `make check-protocol-closure`.
package protocol
