...
pi-assets:
	...
	@cp .pi/extensions/ailang-exec.ts .pi/extensions/ailang-lsp-lite.ts internal/executor/pi/profile_assets/
	@echo "pi_assets synced from .pi/extensions (+ the execution pair into internal/executor/pi/profile_assets)"
...
verify-pi-assets:
	...
	@for f in ailang-exec.ts ailang-lsp-lite.ts; do cmp -s .pi/extensions/$$f internal/executor/pi/profile_assets/$$f || \
