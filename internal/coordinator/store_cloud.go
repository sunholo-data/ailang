...
func (s *CloudStore) MarkTaskPendingApproval(ctx context.Context, id, worktreePath, worktreeBranch, baseBranch, baseCommit string, result *ExecuteResult) error {
	return fmt.Errorf("cloud store not yet implemented")
}
...
func (s *CloudStore) ResetTaskToPending(ctx context.Context, id string) error {
	return fmt.Errorf("cloud store not yet implemented")
}
...
// GetApprovalRequestByTaskAnyStatus retrieves approval request by task ID regardless of status
func (s *CloudStore) GetApprovalRequestByTaskAnyStatus(ctx context.Context, taskID string) (*ApprovalRequestRecord, error) {
	return nil, fmt.Errorf("cloud store not yet implemented")
}
