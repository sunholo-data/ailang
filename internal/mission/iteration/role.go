...
// RunRoleWithHeartbeat owns the legacy single-stage durable lifecycle.
// Iteration children use parent-aware fences in Service instead.
func RunRoleWithHeartbeat(ctx context.Context, req dispatch.Request, receipt, dbPath string, models *modelreg.ModelsConfig, factory dispatch.Factory, heartbeatInterval time.Duration) (*dispatch.Report, error) {
