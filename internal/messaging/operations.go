...
// parseTargetAgent extracts target_agent from context_json if present (backward compatibility)
func parseTargetAgent(contextJSON string) string {
	return parseThreadContext(contextJSON).TargetAgent
}
