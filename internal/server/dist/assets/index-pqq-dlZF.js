...
`);return L>j.length*.8&&(j=j.slice(0,L)),{needsTruncation:!0,truncated:j,fullLength:_.length,lineCount:V}},w=_=>{k(V=>{const T=new Set(V);return T.has(_)?T.delete(_):T.add(_),T})};U.useEffect(()=>{e!=null&&e.workspace?g(e.workspace):g("")},[e==null?void 0:e.id,e==null?void 0:e.workspace]),U.useEffect(()=>{var _;(_=o.current)==null||_.scrollIntoView({behavior:"smooth"})},[t]);const P=_=>{g(_),r&&r(_)},M=()=>{a.trim()&&(n(a,u,f||void 0),s(""))},H=_=>{_.key==="Enter"&&!_.shiftKey&&(_.preventDefault(),M())},O=_=>new Date(_).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),z=_=>_.length>12?`${_.slice(0,8)}...`:_,D=_=>{if(!_.metadata_json)return null;try{return JSON.parse(_.metadata_json).approval_id||null}catch{return null}},Y=_=>{const V=C.get(_)||"";i&&(i(_,V),h(T=>new Set(T).add(_)),E(T=>{const j=new Map(T);return j.delete(_),j}))},G=_=>{const V=C.get(_)||"";if(!V.trim()){alert("Please provide a reason for rejection");return}l&&(l(_,V),h(T=>new Set(T).add(_)),E(T=>{const j=new Map(T);return j.delete(_),j}))},W=(_,V)=>{E(T=>new Map(T).set(_,V))};return e?c.jsxs("div",{className:"conversation-view",children:[c.jsxs("div",{className:"conversation-header",children:[c.jsxs("div",{className:"header-info",children:[c.jsx("h2",{className:"thread-title",children:e.title}),e.target_agent&&c.jsxs("span",{className:"thread-agent-badge",children:[Ae.bot,e.target_agent]})]}),c.jsxs("div",{className:"header-stats",children:[c.jsxs("span",{className:"message-count",children:[t.length," messages"]}),c.jsx("span",{className:"thread-id",title:e.id,children:z(e.id)})]})]}),c.jsxs("div",{className:"messages-container",children:[t.length===0?c.jsxs("div",{className:"empty-messages",children:[c.jsx("div",{className:"empty-icon",children:c.jsx("svg",{width:"40",height:"40",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:c.jsx("path",{d:"M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"})})}),c.jsx("p",{children:"No messages yet"}),c.jsx("span",{className:"hint",children:"Send a message to start the conversation"})]}):t.map((_,V)=>{const T=_.from_type==="human",j=V===0||t[V-1].from_type!==_.from_type,v=y.has(_.id),{needsTruncation:L,truncated:B,fullLength:x,lineCount:te}=b(_.content),ke=v?_.content:B;return c.jsxs("div",{className:`message ${T?"human":"agent"}`,children:[c.jsx("div",{className:`message-avatar ${j?"visible":""}`,children:j&&(T?Ae.user:Ae.bot)}),c.jsxs("div",{className:"message-body",children:[j&&c.jsxs("div",{className:"message-meta",children:[c.jsx("span",{className:"sender-name",children:_.from_id}),c.jsxs("span",{className:"kind-badge",children:[f0(_.kind)," ",_.kind]}),c.jsx("span",{className:"message-time",children:O(_.created_at)})]}),c.jsxs("div",{className:"message-content",children:[_.kind==="result"||!T?c.jsx(o0,{components:{a:({href:$,children:ce})=>{let we=$;return $&&$.startsWith("/")&&!$.startsWith("//")&&(we=`file://${$}`),c.jsx("a",{href:we,target:"_blank",rel:"noopener noreferrer",children:ce})},code:({className:$,children:ce,...we})=>!$?c.jsx("code",{className:"inline-code",...we,children:ce}):c.jsx("code",{className:$,...we,children:ce})},children:ke}):ke,L&&c.jsx("div",{className:"truncation-notice",children:c.jsx("button",{className:"expand-btn",onClick:()=>w(_.id),children:v?c.jsx(c.Fragment,{children:"Show less"}):c.jsxs(c.Fragment,{children:["Show more (",Math.round(x/1024),"KB, ",te," lines)"]})})}),_.kind==="approval_request"&&(()=>{const $=D(_),ce=$&&p.has($);return $?c.jsx("div",{className:"inline-approval",children:ce?c.jsxs("div",{className:"approval-handled",children:[Ae.check,c.jsx("span",{children:"Action taken"})]}):c.jsxs(c.Fragment,{children:[c.jsx("input",{type:"text",className:"approval-notes-input",placeholder:"Notes (required for rejection)...",value:C.get($)||"",onChange:we=>W($,we.target.value)}),c.jsxs("div",{className:"approval-actions",children:[c.jsxs("button",{className:"reject-btn",onClick:()=>G($),title:"Reject",children:[Ae.x,"Reject"]}),c.jsxs("button",{className:"approve-btn",onClick:()=>Y($),title:"Approve",children:[Ae.check,"Approve"]})]})]})}):null})(),_.kind==="result"&&(()=>{const $=d0(_.metadata_json);return!$||!$.files_created||$.files_created.length===0?null:c.jsxs("div",{className:"files-created-section",children:[c.jsxs("div",{className:"files-header",children:[Ae.file,c.jsxs("span",{children:["Files Created (",$.files_created.length,")"]}),$.workspace&&c.jsxs("span",{className:"workspace-badge",title:$.workspace,children:[Ae.folder,$.workspace.split("/").pop()]})]}),c.jsx("ul",{className:"files-list",children:$.files_created.map((ce,we)=>c.jsx("li",{className:"file-item",children:c.jsx("a",{href:`file://${$.workspace?$.workspace+"/":""}${ce}`,target:"_blank",rel:"noopener noreferrer",title:ce,children:ce})},we))})]})})()]}),c.jsxs("div",{className:"message-footer",children:[c.jsxs("span",{className:"message-seq",children:["#",_.message_seq]}),_.delivery_state!=="acked"&&c.jsx("span",{className:`delivery-status ${_.delivery_state}`,children:_.delivery_state==="pending"?"sending...":"delivered"})]})]})]},_.id)}),c.jsx("div",{ref:o})]}),c.jsxs("div",{className:"input-area",children:[m&&c.jsxs("div",{className:"workspace-input-row",children:[c.jsx("input",{type:"text",value:f,onChange:_=>P(_.target.value),onBlur:()=>{r&&r(f)},placeholder:"/path/to/working/directory (leave empty for fresh workspace)",className:"workspace-input"}),c.jsx("button",{onClick:async()=>{try{const V=await(await fetch("/api/select-folder")).json();!V.cancelled&&V.path&&P(V.path)}catch(_){console.error("Failed to open folder picker:",_)}},className:"workspace-browse",title:"Browse for folder",children:c.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("path",{d:"M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"}),c.jsx("line",{x1:"12",y1:"11",x2:"12",y2:"17"}),c.jsx("line",{x1:"9",y1:"14",x2:"15",y2:"14"})]})}),f&&c.jsx("button",{onClick:()=>{P(""),S(!1)},className:"workspace-clear",children:"Clear"})]}),c.jsxs("div",{className:"input-wrapper",children:[c.jsx("button",{onClick:()=>S(!m),className:`workspace-toggle ${f?"has-workspace":""}`,title:f||"Set working directory",children:c.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:c.jsx("path",{d:"M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"})})}),c.jsxs("select",{value:u,onChange:_=>d(_.target.value),className:"kind-selector",children:[c.jsx("option",{value:"directive",children:"Directive"}),c.jsx("option",{value:"question",children:"Question"})]}),c.jsx("textarea",{value:a,onChange:_=>s(_.target.value),onKeyPress:H,placeholder:f?`Message (workspace: ${f.split("/").pop()})`:"Type a message...",rows:1}),c.jsx("button",{onClick:M,className:"send-btn",disabled:!a.trim(),children:Ae.send})]}),c.jsxs("div",{className:"input-hint",children:["Press ",c.jsx("kbd",{children:"Enter"})," to send, ",c.jsx("kbd",{children:"Shift + Enter"})," for new line"]})]}),c.jsx("style",{children:`
      ...
      `})]})};wo.createRoot(document.getElementById("root")).render(c.jsx(Bt.StrictMode,{children:c.jsx(x0,{})}));
