 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(C,E){var m=C.length;C.push(E);e:for(;0<m;){var P=m-1>>>1,B=C[P];if(0<i(B,E))C[P]=E,C[m]=B,m=P;else break e}}function n(C){return C.length===0?null:C[0]}function r(C){if(C.length===0)return null;var E=C[0],m=C.pop();if(m!==E){C[0]=m;e:for(var P=0,B=C.length,x=B>>>1;P<x;){var te=2*(P+1)-1,Se=C[te],ee=te+1,Ie=C[ee];if(0>i(Se,m))ee<B&&0>i(Ie,Se)?(C[P]=Ie,C[ee]=m,P=ee):(C[P]=Se,C[te]=m,P=te);else if(ee<B&&0>i(Ie,m))C[P]=Ie,C[ee]=m,P=ee;else break e}}return E}function i(C,E){var m=C.sortIndex-E.sortIndex;return m!==0?m:C.id-E.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var o=Date,a=o.now();e.unstable_now=function(){return o.now()-a}}var s=[],c=[],d=1,f=null,g=3,p=!1,w=!1,S=!1,I=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(C){for(var E=n(c);E!==null;){if(E.callback===null)r(c);else if(E.startTime<=C)r(c),E.sortIndex=E.expirationTime,t(s,E);else break;E=n(c)}}function b(C){if(S=!1,y(C),!w)if(n(s)!==null)w=!0,Q(j);else{var E=n(c);E!==null&&re(b,E.startTime-C)}}function j(C,E){w=!1,S&&(S=!1,h(T),T=-1),p=!0;var m=g;try{for(y(E),f=n(s);f!==null&&(!(f.expirationTime>E)||C&&!_());){var P=f.callback;if(typeof P=="function"){f.callback=null,g=f.priorityLevel;var B=P(f.expirationTime<=E);E=e.unstable_now(),typeof B=="function"?f.callback=B:f===n(s)&&r(s),y(E)}else r(s);f=n(s)}if(f!==null)var x=!0;else{var te=n(c);te!==null&&re(b,te.startTime-E),x=!1}return x}finally{f=null,g=m,p=!1}}var k=!1,N=null,T=-1,R=5,L=-1;function _(){return!(e.unstable_now()-L<R)}function D(){if(N!==null){var C=e.unstable_now();L=C;var E=!0;try{E=N(!0,C)}finally{E?W():(k=!1,N=null)}}else k=!1}var W;if(typeof v=="function")W=function(){v(D)};else if(typeof MessageChannel<"u"){var Y=new MessageChannel,H=Y.port2;Y.port1.onmessage=D,W=function(){H.postMessage(null)}}else W=function(){I(D,0)};function Q(C){N=C,k||(k=!0,W())}function re(C,E){T=I(function(){C(e.unstable_now())},E)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(C){C.callback=null},e.unstable_continueExecution=function(){w||p||(w=!0,Q(j))},e.unstable_forceFrameRate=function(C){0>C||125<C?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<C?Math.floor(1e3/C):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(C){switch(g){case 1:case 2:case 3:var E=3;break;default:E=g}var m=g;g=E;try{return C()}finally{g=m}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(C,E){switch(C){case 1:case 2:case 3:case 4:case 5:break;default:C=3}var m=g;g=C;try{return E()}finally{g=m}},e.unstable_scheduleCallback=function(C,E,m){var P=e.unstable_now();switch(typeof m=="object"&&m!==null?(m=m.delay,m=typeof m=="number"&&0<m?P+m:P):m=P,C){case 1:var B=-1;break;case 2:B=250;break;case 5:B=1073741823;break;case 4:B=1e4;break;default:B=5e3}return B=m+B,C={id:d++,callback:E,priorityLevel:C,startTime:m,expirationTime:B,sortIndex:-1},m>P?(C.sortIndex=m,t(c,C),n(s)===null&&C===n(c)&&(S?(h(T),T=-1):S=!0,re(b,m-P))):(C.sortIndex=B,t(s,C),w||p||(w=!0,Q(j))),C},e.unstable_shouldYield=_,e.unstable_wrapCallback=function(C){var E=g;return function(){var m=g;g=E;try{return C.apply(this,arguments)}finally{g=m}}}})(td);ed.exports=td;var dh=ed.exports;/**
 * @license React
...
`);return x>P.length*.8&&(P=P.slice(0,x)),{needsTruncation:!0,truncated:P,fullLength:C.length,lineCount:E}},T=C=>{b(E=>{const m=new Set(E);return m.has(C)?m.delete(C):m.add(C),m})};U.useEffect(()=>{e!=null&&e.workspace?g(e.workspace):g("")},[e==null?void 0:e.id,e==null?void 0:e.workspace]),U.useEffect(()=>{var C;(C=o.current)==null||C.scrollIntoView({behavior:"smooth"})},[t]);const R=C=>{g(C),r&&r(C)},L=()=>{a.trim()&&(n(a,c,f||void 0),s(""))},_=C=>{C.key==="Enter"&&!C.shiftKey&&(C.preventDefault(),L())},D=C=>new Date(C).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),W=C=>C.length>12?`${C.slice(0,8)}...`:C,Y=C=>{if(!C.metadata_json)return null;try{return JSON.parse(C.metadata_json).approval_id||null}catch{return null}},H=C=>{const E=S.get(C)||"";i&&(i(C,E),v(m=>new Set(m).add(C)),I(m=>{const P=new Map(m);return P.delete(C),P}))},Q=C=>{const E=S.get(C)||"";if(!E.trim()){alert("Please provide a reason for rejection");return}l&&(l(C,E),v(m=>new Set(m).add(C)),I(m=>{const P=new Map(m);return P.delete(C),P}))},re=(C,E)=>{I(m=>new Map(m).set(C,E))};return e?u.jsxs("div",{className:"conversation-view",children:[u.jsxs("div",{className:"conversation-header",children:[u.jsxs("div",{className:"header-info",children:[u.jsx("h2",{className:"thread-title",children:e.title}),e.target_agent&&u.jsxs("span",{className:"thread-agent-badge",children:[ze.bot,e.target_agent]})]}),u.jsxs("div",{className:"header-stats",children:[u.jsxs("span",{className:"message-count",children:[t.length," messages"]}),u.jsx("span",{className:"thread-id",title:e.id,children:W(e.id)})]})]}),u.jsxs("div",{className:"messages-container",children:[t.length===0?u.jsxs("div",{className:"empty-messages",children:[u.jsx("div",{className:"empty-icon",children:u.jsx("svg",{width:"40",height:"40",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:u.jsx("path",{d:"M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"})})}),u.jsx("p",{children:"No messages yet"}),u.jsx("span",{className:"hint",children:"Send a message to start the conversation"})]}):t.map((C,E)=>{const m=C.from_type==="human",P=E===0||t[E-1].from_type!==C.from_type,B=y.has(C.id),{needsTruncation:x,truncated:te,fullLength:Se,lineCount:ee}=N(C.content),Ie=B?C.content:te,it=f0(C);return u.jsxs("div",{className:`message ${m?"human":"agent"}${it?" running-status":""}`,children:[u.jsx("div",{className:`message-avatar ${P?"visible":""}`,children:P&&(m?ze.user:ze.bot)}),u.jsxs("div",{className:"message-body",children:[P&&u.jsxs("div",{className:"message-meta",children:[u.jsx("span",{className:"sender-name",children:C.from_id}),u.jsxs("span",{className:`kind-badge${it?" running":""}`,children:[it?ze.spinner:p0(C.kind)," ",C.kind]}),u.jsx("span",{className:"message-time",children:D(C.created_at)})]}),u.jsxs("div",{className:"message-content",children:[C.kind==="result"||!m?u.jsx(o0,{components:{a:({href:G,children:be})=>{let Fe=G;return G&&G.startsWith("/")&&!G.startsWith("//")&&(Fe=`file://${G}`),u.jsx("a",{href:Fe,target:"_blank",rel:"noopener noreferrer",children:be})},code:({className:G,children:be,...Fe})=>!G?u.jsx("code",{className:"inline-code",...Fe,children:be}):u.jsx("code",{className:G,...Fe,children:be})},children:Ie}):Ie,x&&u.jsx("div",{className:"truncation-notice",children:u.jsx("button",{className:"expand-btn",onClick:()=>T(C.id),children:B?u.jsx(u.Fragment,{children:"Show less"}):u.jsxs(u.Fragment,{children:["Show more (",Math.round(Se/1024),"KB, ",ee," lines)"]})})}),C.kind==="approval_request"&&(()=>{const G=Y(C),be=G&&h.has(G);return G?u.jsx("div",{className:"inline-approval",children:be?u.jsxs("div",{className:"approval-handled",children:[ze.check,u.jsx("span",{children:"Action taken"})]}):u.jsxs(u.Fragment,{children:[u.jsx("input",{type:"text",className:"approval-notes-input",placeholder:"Notes (required for rejection)...",value:S.get(G)||"",onChange:Fe=>re(G,Fe.target.value)}),u.jsxs("div",{className:"approval-actions",children:[u.jsxs("button",{className:"reject-btn",onClick:()=>Q(G),title:"Reject",children:[ze.x,"Reject"]}),u.jsxs("button",{className:"approve-btn",onClick:()=>H(G),title:"Approve",children:[ze.check,"Approve"]})]})]})}):null})(),C.kind==="result"&&(()=>{const G=d0(C.metadata_json);if(!G||!G.files_created||G.files_created.length===0)return null;const be=j.has(C.id),Fe=()=>{k(Ut=>{const Ht=new Set(Ut);return Ht.has(C.id)?Ht.delete(C.id):Ht.add(C.id),Ht})};return u.jsxs("div",{className:"files-created-section",children:[u.jsxs("button",{className:`files-toggle-btn ${be?"expanded":""}`,onClick:Fe,children:[ze.file,u.jsxs("span",{children:["Files Created (",G.files_created.length,")"]}),G.workspace&&u.jsxs("span",{className:"workspace-badge",title:G.workspace,children:[ze.folder,G.workspace.split("/").pop()]}),u.jsx("span",{className:"toggle-chevron",children:be?"▼":"▶"})]}),be&&u.jsx("ul",{className:"files-list",children:G.files_created.map((Ut,Ht)=>u.jsx("li",{className:"file-item",children:u.jsx("a",{href:`file://${G.workspace?G.workspace+"/":""}${Ut}`,target:"_blank",rel:"noopener noreferrer",title:Ut,children:Ut})},Ht))})]})})()]}),u.jsxs("div",{className:"message-footer",children:[u.jsxs("span",{className:"message-seq",children:["#",C.message_seq]}),C.delivery_state!=="acked"&&u.jsx("span",{className:`delivery-status ${C.delivery_state}`,children:C.delivery_state==="pending"?"sending...":"delivered"})]})]})]},C.id)}),u.jsx("div",{ref:o})]}),u.jsxs("div",{className:"input-area",children:[p&&u.jsxs("div",{className:"workspace-input-row",children:[u.jsx("input",{type:"text",value:f,onChange:C=>R(C.target.value),onBlur:()=>{r&&r(f)},placeholder:"/path/to/working/directory (leave empty for fresh workspace)",className:"workspace-input"}),u.jsx("button",{onClick:async()=>{try{const E=await(await fetch("/api/select-folder")).json();!E.cancelled&&E.path&&R(E.path)}catch(C){console.error("Failed to open folder picker:",C)}},className:"workspace-browse",title:"Browse for folder",children:u.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[u.jsx("path",{d:"M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"}),u.jsx("line",{x1:"12",y1:"11",x2:"12",y2:"17"}),u.jsx("line",{x1:"9",y1:"14",x2:"15",y2:"14"})]})}),f&&u.jsx("button",{onClick:()=>{R(""),w(!1)},className:"workspace-clear",children:"Clear"})]}),u.jsxs("div",{className:"input-wrapper",children:[u.jsx("button",{onClick:()=>w(!p),className:`workspace-toggle ${f?"has-workspace":""}`,title:f||"Set working directory",children:u.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:u.jsx("path",{d:"M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"})})}),u.jsxs("select",{value:c,onChange:C=>d(C.target.value),className:"kind-selector",children:[u.jsx("option",{value:"directive",children:"Directive"}),u.jsx("option",{value:"question",children:"Question"})]}),u.jsx("textarea",{value:a,onChange:C=>s(C.target.value),onKeyPress:_,placeholder:f?`Message (workspace: ${f.split("/").pop()})`:"Type a message...",rows:1}),u.jsx("button",{onClick:L,className:"send-btn",disabled:!a.trim(),children:ze.send})]}),u.jsxs("div",{className:"input-hint",children:["Press ",u.jsx("kbd",{children:"Enter"})," to send, ",u.jsx("kbd",{children:"Shift + Enter"})," for new line"]})]}),u.jsx("style",{children:`
      ...
      `})]}):null},m0=({url:e,instanceId:t,onMessage:n,onBatch:r,onError:i,reconnectInterval:l=5e3})=>{const o=U.useRef(null),[a,s]=U.useState(!1),[c,d]=U.useState(null),f=U.useRef(null),g=U.useRef(new Map),p=U.useCallback(()=>{try{const b=`${e}?instance_id=${t}`;o.current=new WebSocket(b),o.current.onopen=()=>{console.log("WebSocket connected"),s(!0),d(null),g.current.forEach((j,k)=>{I(k,j)})},o.current.onmessage=j=>{try{const k=JSON.parse(j.data);w(k)}catch(k){console.error("Failed to parse WebSocket message:",k)}},o.current.onerror=j=>{console.error("WebSocket error:",j),d("Connection error")},o.current.onclose=()=>{console.log("WebSocket disconnected"),s(!1),f.current=setTimeout(()=>{console.log("Attempting to reconnect..."),p()},l)}}catch(b){console.error("Failed to connect to WebSocket:",b),d("Failed to connect")}},[e,t,l]),w=U.useCallback(b=>{switch(b.type){case"message":n&&b.data&&n(b.data);break;case"batch":if(r&&b.data){const j=b.data;r(j),n&&j.messages.forEach(k=>n(k))}break;case"error":i&&b.data&&i(b.data),console.error("WebSocket error event:",b.data);break;case"pong":break;default:console.log("Unknown event type:",b.type)}},[n,r,i]),S=U.useCallback(b=>{o.current&&o.current.readyState===WebSocket.OPEN?o.current.send(JSON.stringify(b)):console.warn("WebSocket not connected, cannot send event")},[]),I=U.useCallback((b,j=0)=>{g.current.set(b,j);const k={type:"subscribe",timestamp:Date.now(),data:{thread_id:b,from_seq:j}};S(k)},[S]),h=U.useCallback((b,j)=>{const k=g.current.get(b)||0;j>k&&g.current.set(b,j);const N={type:"ack",timestamp:Date.now(),data:{thread_id:b,ack_seq:j}};S(N)},[S]),v=U.useCallback(()=>{const b={type:"ping",timestamp:Date.now()};S(b)},[S]),y=U.useCallback(b=>{g.current.delete(b)},[]);return U.useEffect(()=>(p(),()=>{f.current&&clearTimeout(f.current),o.current&&o.current.close()}),[p]),U.useEffect(()=>{if(!a)return;const b=setInterval(()=>{v()},3e4);return()=>clearInterval(b)},[a,v]),{isConnected:a,connectionError:c,subscribe:I,unsubscribe:y,acknowledge:h,ping:v}},g0=({connected:e})=>u.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:e?u.jsxs(u.Fragment,{children:[u.jsx("path",{d:"M22 11.08V12a10 10 0 1 1-5.93-9.14"}),u.jsx("polyline",{points:"22 4 12 14.01 9 11.01"})]}):u.jsxs(u.Fragment,{children:[u.jsx("circle",{cx:"12",cy:"12",r:"10"}),u.jsx("line",{x1:"15",y1:"9",x2:"9",y2:"15"}),u.jsx("line",{x1:"9",y1:"9",x2:"15",y2:"15"})]})}),v0=({websocketUrl:e,instanceId:t,initialThreadId:n,onThreadNavigated:r})=>{const[i,l]=U.useState([]),[o,a]=U.useState(null),[s,c]=U.useState(new Map),[d,f]=U.useState(new Map),[g,p]=U.useState([]),[w,S]=U.useState(!1),[I,h]=U.useState(""),{isConnected:v,subscribe:y,acknowledge:b}=m0({url:e,instanceId:t,onMessage:j,onBatch:k});function j(E){const m={id:E.id,thread_id:E.thread_id,message_seq:E.message_seq,created_at:E.created_at,from_type:E.from_type,from_id:E.from_id,to_type:E.to_type,to_id:E.to_id,kind:E.kind,subject:E.subject,content:E.content,metadata_json:E.metadata_json,delivery_state:"visible",business_state:"open"};c(P=>{const B=P.get(m.thread_id)||[];return B.find(x=>x.id===m.id)?P:new Map(P).set(m.thread_id,[...B,m].sort((x,te)=>x.message_seq-te.message_seq))}),m.thread_id!==o&&f(P=>{const B=P.get(m.thread_id)||0;return new Map(P).set(m.thread_id,B+1)}),b(m.thread_id,m.message_seq)}function k(E){E.messages.forEach(m=>{j(m)})}const N=U.useCallback(E=>{if(a(E),f(m=>{const P=new Map(m);return P.delete(E),P}),v){const m=s.get(E)||[],P=m.length>0?Math.max(...m.map(B=>B.message_seq)):0;y(E,P)}},[v,y,s]),T=U.useCallback(async(E,m,P)=>{if(!o)return;const B=P?JSON.stringify({workspace:P}):void 0;try{const x=await fetch("/api/messages",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({thread_id:o,from_type:"human",from_id:"user",to_type:"ailang_instance",to_id:t,kind:m,content:E,metadata_json:B})});if(!x.ok){console.error("Failed to send message:",await x.text());return}const te=await x.json();c(Se=>{const ee=Se.get(o)||[];return ee.find(Ie=>Ie.id===te.id)?Se:new Map(Se).set(o,[...ee,te])})}catch(x){console.error("Error sending message:",x)}},[o,t]);U.useEffect(()=>{(async()=>{try{const m=await fetch("/api/threads");if(!m.ok){console.error("Failed to fetch threads:",await m.text());return}const P=await m.json();l(P),P.length>0&&!o&&a(P[0].id)}catch(m){console.error("Error fetching threads:",m)}})()},[]),U.useEffect(()=>{n&&i.length>0&&(i.some(m=>m.id===n)&&(a(n),f(m=>{const P=new Map(m);return P.delete(n),P})),r&&r())},[n,i,r]);const R=U.useCallback(async E=>{try{const m=await fetch("/api/threads",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({title:E,created_by_type:"human",created_by_id:"user",target_agent:t})});if(!m.ok){console.error("Failed to create thread:",await m.text());return}const P=await m.json();l(B=>[P,...B]),a(P.id)}catch(m){console.error("Error creating thread:",m)}},[t]),L=U.useCallback(async()=>{try{const E=await fetch("/api/agents");if(!E.ok){console.error("Failed to fetch agents:",await E.text());return}const m=await E.json();p(m.running||[])}catch(E){console.error("Error fetching agents:",E)}},[]);U.useEffect(()=>{L();const E=setInterval(L,5e3);return()=>clearInterval(E)},[L]);const _=U.useCallback(async()=>{if(I.trim())try{const E=await fetch("/api/agents",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({instance_id:I.trim()})});if(!E.ok){const P=await E.text();console.error("Failed to launch agent:",P),alert(`Failed to launch agent: ${P}`);return}const m=await E.json();p(P=>[...P,m]),h(""),S(!1)}catch(E){console.error("Error launching agent:",E)}},[I]),D=U.useCallback(async E=>{try{const m=await fetch(`/api/agents/${E}`,{method:"DELETE"});if(!m.ok){console.error("Failed to stop agent:",await m.text());return}p(P=>P.filter(B=>B.instance_id!==E))}catch(m){console.error("Error stopping agent:",m)}},[]),W=U.useCallback(async E=>{if(o)try{const m=await fetch(`/api/threads/${o}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({workspace:E})});if(!m.ok){console.error("Failed to update workspace:",await m.text());return}const P=await m.json();l(B=>B.map(x=>x.id===o?P:x))}catch(m){console.error("Error updating workspace:",m)}},[o]),Y=U.useCallback(async E=>{try{const m=await fetch(`/api/threads/${E}`,{method:"DELETE"});if(!m.ok){console.error("Failed to delete thread:",await m.text());return}l(P=>P.filter(B=>B.id!==E)),c(P=>{const B=new Map(P);return B.delete(E),B}),f(P=>{const B=new Map(P);return B.delete(E),B}),o===E&&a(null)}catch(m){console.error("Error deleting thread:",m)}},[o]),H=U.useCallback(async(E,m)=>{try{const P=await fetch(`/api/threads/${E}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({title:m})});if(!P.ok){console.error("Failed to rename thread:",await P.text());return}const B=await P.json();l(x=>x.map(te=>te.id===E?B:te))}catch(P){console.error("Error renaming thread:",P)}},[]),Q=U.useCallback(async(E,m)=>{try{const P=await fetch(`/api/approvals/${E}/approve`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({reviewed_by:"user",review_notes:m})});if(!P.ok){const B=await P.text();console.error("Failed to approve request:",B),alert(`Failed to approve: ${B}`);return}console.log("Approval approved successfully")}catch(P){console.error("Error approving request:",P)}},[]),re=U.useCallback(async(E,m)=>{try{const P=await fetch(`/api/approvals/${E}/reject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({reviewed_by:"user",review_notes:m})});if(!P.ok){const B=await P.text();console.error("Failed to reject request:",B),alert(`Failed to reject: ${B}`);return}console.log("Approval rejected successfully")}catch(P){console.error("Error rejecting request:",P)}},[]),C=o?s.get(o)||[]:[];return u.jsxs("div",{className:"message-center",children:[u.jsxs("div",{className:"status-bar",children:[u.jsxs("div",{className:`status-indicator ${v?"connected":"disconnected"}`,children:[u.jsx(g0,{connected:v}),u.jsx("span",{children:v?"Connected":"Disconnected"})]}),u.jsxs("div",{className:"status-meta",children:[u.jsxs("span",{className:"thread-count",children:[i.length," threads"]}),u.jsxs("span",{className:"agent-count",children:[g.length," agents"]}),u.jsx("button",{className:"launch-agent-btn",onClick:()=>S(!0),children:"+ Agent"})]})]}),g.length>0&&u.jsx("div",{className:"agents-bar",children:g.map(E=>u.jsxs("div",{className:"agent-chip",children:[u.jsx("span",{className:"agent-pulse"}),u.jsx("span",{className:"agent-name",children:E.instance_id}),u.jsxs("span",{className:"agent-pid",children:["PID ",E.pid]}),u.jsx("button",{className:"agent-stop-btn",onClick:()=>D(E.instance_id),title:"Stop agent",children:"×"})]},E.instance_id))}),w&&u.jsx("div",{className:"modal-overlay",onClick:()=>S(!1),children:u.jsxs("div",{className:"modal-content",onClick:E=>E.stopPropagation(),children:[u.jsx("h3",{children:"Launch New Agent"}),u.jsx("input",{type:"text",value:I,onChange:E=>h(E.target.value),placeholder:"Enter instance ID (e.g., agent-2)",autoFocus:!0,onKeyDown:E=>{E.key==="Enter"&&_(),E.key==="Escape"&&S(!1)}}),u.jsxs("div",{className:"modal-actions",children:[u.jsx("button",{className:"cancel-btn",onClick:()=>S(!1),children:"Cancel"}),u.jsx("button",{className:"launch-btn",onClick:_,children:"Launch"})]})]})}),u.jsxs("div",{className:"center-layout",children:[u.jsx("aside",{className:"threads-panel",children:u.jsx(bg,{threads:i,selectedThreadId:o,onSelectThread:N,onCreateThread:R,onDeleteThread:Y,onRenameThread:H,unreadCounts:d})}),u.jsx("main",{className:"conversation-panel",children:o?u.jsx(h0,{thread:i.find(E=>E.id===o),messages:C,onSendMessage:T,onWorkspaceChange:W,onApproveRequest:Q,onRejectRequest:re}):u.jsxs("div",{className:"empty-state",children:[u.jsx("div",{className:"empty-icon",children:u.jsx("svg",{width:"48",height:"48",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:u.jsx("path",{d:"M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"})})}),u.jsx("h3",{children:"Select a conversation"}),u.jsx("p",{children:"Choose a thread from the sidebar or create a new one to get started"})]})})]}),u.jsx("style",{children:`
        .message-center {
          display: flex;
          flex-direction: column;
          height: 100%;
      ...
      `})]})},x0=u.jsxs("svg",{width:"28",height:"28",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round",children:[u.jsx("circle",{cx:"12",cy:"12",r:"10"}),u.jsx("path",{d:"M12 6v12M6 12h12"}),u.jsx("circle",{cx:"12",cy:"12",r:"3",fill:"currentColor"})]}),k0=()=>{const[e,t]=U.useState({type:"overview"}),[n,r]=U.useState(null),[i,l]=U.useState([]),[o,a]=U.useState([]),[s,c]=U.useState(!1),[d,f]=U.useState(""),p=`${window.location.protocol==="https:"?"wss:":"ws:"}//${window.location.host}/ws`;U.useEffect(()=>{const j=async()=>{try{const N=await fetch("/api/hierarchy");if(N.ok){const T=await N.json();r(T)}}catch(N){console.error("Error fetching hierarchy:",N)}};j();const k=setInterval(j,5e3);return()=>clearInterval(k)},[]),U.useEffect(()=>{const j=async()=>{try{const N=await fetch("/api/approvals?status=pending");if(N.ok){const _=await N.json();l(_)}const[T,R]=await Promise.all([fetch("/api/approvals?status=approved"),fetch("/api/approvals?status=rejected")]),L=[];if(T.ok){const _=await T.json();L.push(..._)}if(R.ok){const _=await R.json();L.push(..._)}L.sort((_,D)=>{const W=_.reviewed_at?new Date(_.reviewed_at).getTime():0;return(D.reviewed_at?new Date(D.reviewed_at).getTime():0)-W}),a(L)}catch(N){console.error("Error fetching approvals:",N)}};j();const k=setInterval(j,5e3);return()=>clearInterval(k)},[]);const w=async(j,k)=>{try{const N=await fetch(`/api/approvals/${j}/approve`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({notes:k})});if(!N.ok){console.error("Failed to approve:",await N.text());return}const T=i.find(R=>R.id===j);if(T){const R={...T,status:"approved",reviewed_by:"user",review_notes:k,reviewed_at:Date.now()};a(L=>[R,...L])}l(R=>R.filter(L=>L.id!==j))}catch(N){console.error("Error approving:",N)}},S=async(j,k)=>{try{const N=await fetch(`/api/approvals/${j}/reject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({notes:k})});if(!N.ok){console.error("Failed to reject:",await N.text());return}const T=i.find(R=>R.id===j);if(T){const R={...T,status:"rejected",reviewed_by:"user",review_notes:k,reviewed_at:Date.now()};a(L=>[R,...L])}l(R=>R.filter(L=>L.id!==j))}catch(N){console.error("Error rejecting:",N)}},I=()=>{var k,N;const j=[{label:"All Agents",onClick:()=>t({type:"overview"})}];if(e.type==="agent"&&e.agentId&&j.push({label:e.agentId}),e.type==="thread"&&e.threadId){e.agentId&&j.push({label:e.agentId,onClick:()=>t({type:"agent",agentId:e.agentId})});const T=(k=n==null?void 0:n.root.children)==null?void 0:k.find(L=>L.id===e.agentId),R=(N=T==null?void 0:T.children)==null?void 0:N.find(L=>L.id===e.threadId);j.push({label:(R==null?void 0:R.label)||"Thread"})}return j},h=j=>{var N;const k=(N=n==null?void 0:n.root.children)==null?void 0:N.find(T=>{var R;return(R=T.children)==null?void 0:R.some(L=>L.id===j)});t({type:"thread",agentId:k==null?void 0:k.id,threadId:j})},v=async j=>{if(d.trim())try{const k=await fetch("/api/threads",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({title:d.trim(),created_by_type:"human",created_by_id:"user",target_agent:j})});if(!k.ok){console.error("Failed to create thread:",await k.text());return}const N=await k.json();f(""),c(!1),t({type:"thread",agentId:j,threadId:N.id})}catch(k){console.error("Error creating thread:",k)}},y=()=>{var j,k,N;if(e.type==="overview"&&n)return u.jsx(wg,{aggregate:n.aggregate,agents:n.root.children||[],onSelectAgent:T=>t({type:"agent",agentId:T})});if(e.type==="agent"&&e.agentId){const T=(j=n==null?void 0:n.root.children)==null?void 0:j.find(L=>L.id===e.agentId),R=i.filter(L=>{var _;return(_=T==null?void 0:T.children)==null?void 0:_.some(D=>D.id===L.thread_id)});return u.jsxs("div",{className:"agent-view",children:[u.jsxs("div",{className:"agent-view-header",children:[u.jsx("h2",{children:e.agentId}),u.jsxs("span",{className:"agent-thread-count",children:[((k=T==null?void 0:T.children)==null?void 0:k.length)||0," threads"]})]}),u.jsxs("div",{className:"agent-view-content",children:[u.jsxs("div",{className:"agent-threads",children:[u.jsxs("div",{className:"threads-header",children:[u.jsx("h3",{children:"Threads"}),u.jsx("button",{className:"new-thread-btn",onClick:()=>c(!0),title:"New thread",children:"+ New Thread"})]}),s&&u.jsxs("div",{className:"new-thread-form",children:[u.jsx("input",{type:"text",value:d,onChange:L=>f(L.target.value),onKeyDown:L=>{L.key==="Enter"&&v(e.agentId),L.key==="Escape"&&(c(!1),f(""))},placeholder:"Thread title...",autoFocus:!0}),u.jsxs("div",{className:"form-actions",children:[u.jsx("button",{onClick:()=>{c(!1),f("")},children:"Cancel"}),u.jsx("button",{className:"create-btn",onClick:()=>v(e.agentId),children:"Create"})]})]}),(N=T==null?void 0:T.children)==null?void 0:N.map(L=>u.jsxs("div",{className:"thread-card",onClick:()=>t({type:"thread",agentId:e.agentId,threadId:L.id}),children:[u.jsx("span",{className:"thread-title",children:L.label}),L.badges&&L.badges.length>0&&u.jsx("span",{className:"thread-badges",children:L.badges.map((_,D)=>u.jsx("span",{className:`badge badge-${_.type}`,children:_.count},D))})]},L.id)),(!(T!=null&&T.children)||T.children.length===0)&&!s&&u.jsxs("div",{className:"no-threads",children:["No threads yet",u.jsx("button",{className:"start-thread-btn",onClick:()=>c(!0),children:"Start a conversation"})]})]}),R.length>0&&u.jsxs("div",{className:"agent-approvals",children:[u.jsx("h3",{children:"Pending Approvals"}),u.jsx(y0,{approvals:R,history:[],onApprove:w,onReject:S,onNavigateToThread:h})]})]})]})}return e.type==="thread"&&e.threadId?u.jsx(v0,{websocketUrl:p,instanceId:e.agentId||"default",initialThreadId:e.threadId,onThreadNavigated:()=>{}}):u.jsx("div",{className:"empty-state",children:u.jsx("p",{children:"Select an agent or thread from the sidebar"})})},b=(i==null?void 0:i.filter(j=>j.status==="pending").length)||0;return u.jsxs("div",{className:"app",children:[u.jsxs("header",{className:"app-header",children:[u.jsxs("div",{className:"header-brand",children:[u.jsx("div",{className:"brand-logo",children:x0}),u.jsxs("div",{className:"brand-text",children:[u.jsx("h1",{children:"AILANG"}),u.jsx("span",{className:"brand-subtitle",children:"Collaboration Hub"})]})]}),u.jsxs("div",{className:"header-meta",children:[b>0&&u.jsxs("span",{className:"pending-badge",title:`${b} pending approvals`,children:[b," pending"]}),u.jsx("span",{className:"version-tag",children:"v0.5.0"})]})]}),u.jsxs("div",{className:"app-body",children:[u.jsx("aside",{className:"app-sidebar",children:u.jsx(vg,{selection:e,onSelect:t})}),u.jsxs("main",{className:"app-main",children:[e.type!=="overview"&&u.jsx(Sg,{items:I()}),u.jsx("div",{className:"main-content",children:y()})]})]}),u.jsx("style",{children:`
        .app {
          display: flex;
          flex-direction: column;
          height: 100vh;
