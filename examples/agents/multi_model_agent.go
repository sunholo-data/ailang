...
func main() {
	...
	log.Println("  ./bin/send-message multi-model-agent '{\"action\": \"analyze\"}'")
	log.Println("")
	log.Println("  # Use Gemini explicitly")
	log.Println("  ./bin/send-message multi-model-agent '{\"model\": \"gemini\", \"action\": \"analyze\"}'")
	log.Println("")
	log.Println("  # Use GPT-4")
	log.Println("  ./bin/send-message multi-model-agent '{\"model\": \"gpt-4\", \"action\": \"analyze\"}'")
	log.Println("")
	log.Println("  # Use o1 (reasoning model)")
	log.Println("  ./bin/send-message multi-model-agent '{\"model\": \"o1\", \"action\": \"analyze\"}'")
	log.Println("")
