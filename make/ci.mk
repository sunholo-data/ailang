...
# CI verification
ci: deps fmt-check vet lint test test-nightly-classifier test-coverage-badge test-lowering verify-no-shim verify-examples verify-examples-toplevel verify-mcp-tools verify-install-guide ## Run full CI verification
