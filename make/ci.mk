...
# CI verification
ci: deps fmt-check vet lint test test-nightly-classifier test-coverage-badge test-lowering verify-no-shim verify-examples verify-examples-toplevel verify-stdlib verify-stdlib-selftest verify-examples-gate-selftest verify-mcp-tools verify-install-guide verify-pi-assets check-boundaries check-git-exec test-check-git-exec check-changelog check-file-sizes check-golden-drift check-protocol-closure check-skills check-tmpfile-hygiene check-home-isolation test-check-autoclose test-check-changelog test-check-protocol-closure test-check-tmpfile-hygiene test-check-home-isolation check-prompt-freeze ## Run full CI verification, including workflow gates
