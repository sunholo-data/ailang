...
.Codex/skills/docs-sync/scripts/check_examples.sh
```
...
.Codex/skills/docs-sync/scripts/derive_roadmap_versions.sh

# Full lifecycle: planned + implemented features
.Codex/skills/docs-sync/scripts/derive_roadmap_versions.sh --full

# Check website consistency (exits 1 if mismatches)
.Codex/skills/docs-sync/scripts/derive_roadmap_versions.sh --check

# JSON output for automation
.Codex/skills/docs-sync/scripts/derive_roadmap_versions.sh --json --full

# Full validation: all features + website check
.Codex/skills/docs-sync/scripts/derive_roadmap_versions.sh --full --check
```
