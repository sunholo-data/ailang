...
.Codex/skills/perf-reviewer/scripts/benchmark.sh

# Run specific benchmark
.Codex/skills/perf-reviewer/scripts/benchmark.sh fibonacci
...
.Codex/skills/perf-reviewer/scripts/benchmark.sh all
...
```bash
.Codex/skills/perf-reviewer/scripts/profile_ailang.sh examples/compute_heavy.ail
```
