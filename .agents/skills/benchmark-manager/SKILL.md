...
.Codex/skills/benchmark-manager/scripts/show_full_prompt.sh json_parse

# 2. Test a benchmark with a specific model
ailang eval-suite --models Codex-haiku-4-5 --benchmarks json_parse

# 3. Check benchmark YAML for common issues
.Codex/skills/benchmark-manager/scripts/check_benchmark.sh benchmarks/json_parse.yml
```
...
**Usage:**
```bash
.Codex/skills/benchmark-manager/scripts/show_full_prompt.sh <benchmark_id>
...
**Usage:**
```bash
.Codex/skills/benchmark-manager/scripts/check_benchmark.sh benchmarks/<name>.yml
```
...
**Usage:**
```bash
.Codex/skills/benchmark-manager/scripts/test_benchmark.sh <benchmark_id> [model]

# Examples:
.Codex/skills/benchmark-manager/scripts/test_benchmark.sh json_parse
.Codex/skills/benchmark-manager/scripts/test_benchmark.sh json_parse Codex-haiku-4-5
```
...
```bash
# Check for issues
.Codex/skills/benchmark-manager/scripts/check_benchmark.sh benchmarks/my_new_benchmark.yml

# Test with cheap model first
ailang eval-suite --models Codex-haiku-4-5 --benchmarks my_new_benchmark
```
...
```bash
.Codex/skills/benchmark-manager/scripts/show_full_prompt.sh failing_benchmark
```
...
ailang eval-suite --models Codex-haiku-4-5 --benchmarks my_test
```
