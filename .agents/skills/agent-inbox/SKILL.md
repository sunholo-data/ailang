...
- **Session starts** - First action in every Codex session (required by AGENTS.md)
...
ailang messages send user "Issue resolved" \
  --title "Status update" --from "Codex"
```
...
- **Required by AGENTS.md**: Session start check is mandatory
