...
**Commands:**
```bash
.Codex/skills/collaboration-hub/scripts/diagnose.sh health          # Server + DB check
.Codex/skills/collaboration-hub/scripts/diagnose.sh task <id>       # Task details
.Codex/skills/collaboration-hub/scripts/diagnose.sh spans <task_id> # Span hierarchy
.Codex/skills/collaboration-hub/scripts/diagnose.sh orphans         # Find orphan spans
.Codex/skills/collaboration-hub/scripts/diagnose.sh costs           # Cost breakdown
.Codex/skills/collaboration-hub/scripts/diagnose.sh recent          # Recent activity
```
