...
.Codex/skills/github-issue-triage/scripts/triage_report.sh

# Just list open issues with labels and age
.Codex/skills/github-issue-triage/scripts/list_open_issues.sh

# Find issues that have been implemented (design docs in implemented/)
.Codex/skills/github-issue-triage/scripts/find_closable.sh

# Match issues to planned design docs (shows what's being worked on)
.Codex/skills/github-issue-triage/scripts/match_design_docs.sh --planned
```
...
**Usage:**
```bash
.Codex/skills/github-issue-triage/scripts/check_auth.sh
```
...
```bash
.Codex/skills/github-issue-triage/scripts/list_open_issues.sh
.Codex/skills/github-issue-triage/scripts/list_open_issues.sh --json
.Codex/skills/github-issue-triage/scripts/list_open_issues.sh --labels bug,enhancement
```
...
**Usage:**
```bash
.Codex/skills/github-issue-triage/scripts/match_design_docs.sh           # All matches
.Codex/skills/github-issue-triage/scripts/match_design_docs.sh --planned # Only planned docs
.Codex/skills/github-issue-triage/scripts/match_design_docs.sh --implemented # Only implemented
```
...
**Usage:**
```bash
.Codex/skills/github-issue-triage/scripts/find_closable.sh           # Report only
.Codex/skills/github-issue-triage/scripts/find_closable.sh --dry-run # Preview close actions
.Codex/skills/github-issue-triage/scripts/find_closable.sh --close   # Actually close issues
```
...
```bash
.Codex/skills/github-issue-triage/scripts/triage_report.sh
.Codex/skills/github-issue-triage/scripts/triage_report.sh --output /tmp/triage.md
```
...
.Codex/skills/github-issue-triage/scripts/find_closable.sh --dry-run

# Close with proper comments
.Codex/skills/github-issue-triage/scripts/find_closable.sh --close
```
...
.Codex/skills/release-manager/scripts/collect_closable_issues.sh 0.6.1 --close
```
