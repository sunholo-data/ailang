...
**Usage:**
```bash
.Codex/skills/parser-developer/scripts/trace_parser.sh test.ail
```
...
**Usage:**
```bash
.Codex/skills/parser-developer/scripts/check_ast_types.sh
```
...
**Usage:**
```bash
.Codex/skills/parser-developer/scripts/find_api.sh internal/parser New
```
