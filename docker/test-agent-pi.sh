...
have "ailang pi tool-profile ailang_only: allowlist, no bash" 'case "$PROFILE_ARGS" in *"--no-builtin-tools --tools read,edit,write,ailang_check,ailang_run") true;; *) false;; esac'
