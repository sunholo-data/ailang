...
func printHelp() {
	...
	fmt.Printf("  %s   Manage persistent authenticated browser identities\n", cyan("browser-profile <cmd>"))
	...
	fmt.Printf("  %s       Mission registry, iteration, role dispatch and reports (see --help)\n", cyan("mission <command>"))
