...
func printHelp() {
	...
	fmt.Printf("  %s              Check agent inbox for messages\n", cyan("agent inbox <agent-id>"))
	fmt.Printf("  %s                   Acknowledge and mark messages as read\n", cyan("agent ack <msg-id>"))
	fmt.Printf("  %s                 Move acknowledged messages back to unread\n", cyan("agent unack <msg-id>"))
