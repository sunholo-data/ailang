...
func watchFile(filename string, trace bool, binopShim bool, failOnShim bool, requireLowering bool, trackInstantiations bool, noMono bool, debugCompile bool, maxRecursionDepth int) {
	...
	// Default to main entrypoint with null args for watch mode, no caps, no stdlib overrides, no env overrides, no CLI args, no relaxModules, no debug-types
	runFile(filename, []string{}, trace, 0, false, false, false, false, binopShim, failOnShim, requireLowering, trackInstantiations, noMono, debugCompile, false, "main", "null", true, false, "", maxRecursionDepth, "", false, false, "", "", "", "", "", false, "", false, false, false, 0)
}
