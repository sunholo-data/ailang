...
func watchFile(filename string, trace bool, binopShim bool, failOnShim bool, requireLowering bool, trackInstantiations bool, noMono bool, debugCompile bool, maxRecursionDepth int) {
	...
	runFile(filename, []string{}, trace, 0, false, false, false, false, binopShim, failOnShim, requireLowering, trackInstantiations, noMono, debugCompile, false, "main", "null", true, false, "", maxRecursionDepth, "", false, false, "", "", "", "", "", false, "", false, false, false, 0, false, "", false, "", false, "", false)
}
