# AILANG v0.4.10 - AI Teaching Prompt
...
**NEW in v0.4.10:** **Array type** with O(1) indexed access for game grids and performance-critical code. Syntax: `#[1, 2, 3]` (literal), `Array[int]` (type). Import `std/array` for operations.
...
- Effect: `! {IO, FS, Net, Env, Debug}` after return type
...
Modules, functions, lambdas, pattern matching, ADTs, records, effects (`! {IO, FS, Net, Env, Debug}`), recursion, numeric conversions, HTTP with headers, **JSON encoding/decoding**, **property-based testing**, **environment variables**, **syntactic sugar** (`::`, `->`, `f()`), **Debug effect** for game/simulation tracing.
...
**This is v0.4.10 - Focus on: Array Type, Debug Effect, JSON Decode, Effect System, State Threading**
