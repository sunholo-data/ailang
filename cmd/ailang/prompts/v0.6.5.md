...
import std/string (split, trim, stringToInt, stringToFloat, contains, find, substring, intToStr, floatToStr, join)  -- join v0.6.5
...
- `foldl(f, acc, xs)` - Left fold (f takes pair: `\(acc, x). ...`)
