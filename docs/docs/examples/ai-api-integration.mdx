...
import ClaudeExample from '!!raw-loader!@site/../examples/experimental/claude_haiku_call.ail';
import OpenAIExample from '!!raw-loader!@site/../examples/experimental/ai_call.ail';
...
<CodeBlock language="typescript" title="examples/experimental/claude_haiku_call.ail">
  {ClaudeExample}
</CodeBlock>
...
<CodeBlock language="typescript" title="examples/experimental/ai_call.ail">
  {OpenAIExample}
</CodeBlock>
