---
sidebar_position: 1
title: AI API Integration Examples
description: HTTP headers, JSON encoding, and structured error handling for AI APIs
---

import CodeBlock from '@theme/CodeBlock';
import ClaudeExample from '!!raw-loader!@site/../examples/runnable/claude_haiku_call.ail';
import OpenAIExample from '!!raw-loader!@site/../examples/runnable/ai_call.ail';
...
<CodeBlock language="typescript" title="examples/runnable/claude_haiku_call.ail">
  {ClaudeExample}
</CodeBlock>
...
ailang run --caps Net,IO examples/runnable/claude_haiku_call.ail
```
...
<CodeBlock language="typescript" title="examples/runnable/ai_call.ail">
  {OpenAIExample}
</CodeBlock>
...
ailang run --caps Net,IO examples/runnable/ai_call.ail
```
...
```ailang
-- Note: JSON decoding is available via the stdlib: import std/json (decode, encode).
-- The manual parsing below is illustrative; prefer std/json in real code.
