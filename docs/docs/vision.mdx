...
> *See [Execution Profiles Design Doc](/docs/architecture/execution-profiles) for the complete architecture.*
...
> *For the full technical vision, see [Shared Semantic State — AILANG's Cognitive Kernel](/docs/architecture/shared-semantic-state)*
...
> *See [Shared Semantic State](/docs/architecture/shared-semantic-state) for the complete technical vision.*
