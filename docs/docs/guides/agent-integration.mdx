...
📖 **[Teaching Prompt {ACTIVE_PROMPT}](/docs/prompts/{ACTIVE_PROMPT})** - Complete AILANG teaching prompt
...
**Essential reading:**
- **[Teaching Prompt v0.5.11](/docs/prompts/v0.5.11)** - Complete syntax guide (MUST READ before coding)
