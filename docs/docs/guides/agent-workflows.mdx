...
:::info Making Claude Aware of Messages
...
- **[Development Workflow](./development-workflow.md)** - Agent-assisted development
- **[Collaboration Hub](./collaboration-hub.md)** - Dashboard for workflow monitoring
- **[Testing Guide](./testing.md)** - Agents need to test their work
- **[Debugging Guide](./debugging.md)** - Troubleshoot agent failures
- **[Evaluation Framework](/docs/guides/evaluation)** - AI benchmark baselines
