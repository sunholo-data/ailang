...
Use the `--type` flag for categorization. Any string is accepted:

| Type | Use For | GitHub Sync |
|------|---------|-------------|
| `bug` | Something broken | Auto (implies --github) |
| `feature` | Feature suggestions | Auto (implies --github) |
| Any other | Custom categories | Manual (requires --github) |
...
See [Agent Messaging - Neural Embeddings](/docs/guides/agent-messaging#neural-embeddings-ollama) for full setup.

---

## Related Documentation

- [Claude Code Integration](/docs/guides/claude-code-integration) — Complete integration guide
- [Agent Workflows](/docs/guides/agent-workflows) — Automated agent workflows
- [Hooks Setup](/docs/guides/hooks-setup) — HTTP hook configuration
- [Coordinator Guide](/docs/guides/coordinator) — Agent orchestration and task delegation
