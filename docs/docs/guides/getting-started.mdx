...
**One-click setup:** the buttons on the [landing page](/) generate deeplinks that pre-fill the config for Claude Desktop, Cursor, and Cline.

**Manual config** (Continue or any other harness):
