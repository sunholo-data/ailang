...
<Icon name="book" inline /> **[AILANG v0.3.8 Teaching Prompt](/docs/prompts/v0.3.8)**
...
### <Icon name="target" inline /> AI Success Metrics (v0.3.8)
...
## <Icon name="check" inline /> Working Examples (v0.3.8)
