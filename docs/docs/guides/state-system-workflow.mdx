...
```bash
# Check messages
ailang messages list --unread                    # All unread
ailang messages list --inbox sprint-executor     # Agent inbox
