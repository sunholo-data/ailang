...
## <Icon name="book" inline /> Canonical Prompt (v0.4.4)

**The official AILANG teaching prompt is maintained at**:

### [prompts/v0.4.4.md](../prompts/v0.4.4)
...
**Current version**: {STABLE_RELEASE} (Teaching prompt: v0.4.4)
...
**For complete syntax guide**, see [prompts/v0.4.4.md](/docs/prompts/v0.4.4)
...
When asking an AI model (Claude, GPT, Gemini) to write AILANG code, provide the full prompt from [prompts/v0.4.4.md](/docs/prompts/v0.4.4).
...
**Version**: v0.4.4 - [View full prompt](/docs/prompts/v0.4.4)
