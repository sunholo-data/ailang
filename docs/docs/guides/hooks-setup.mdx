...
- **[Claude Code Integration Guide](./claude-code-integration.mdx)** - Complete integration guide (read this first!)
- **[Agent Workflows](./agent-workflows.mdx)** - Workflow patterns and examples
- **[Development Workflow](./development-workflow.md)** - Sprint planning and execution with hooks
- **[Debugging Guide](./debugging.md)** - Troubleshoot hook execution issues
- **[State System](./state-system-workflow.mdx)** - Persistent state between sessions
