...
For the two-tier search architecture, see [Semantic Search](/docs/guides/semantic-search).
...
- [Roadmap](/docs/roadmap) - Why this matters and what's coming next
...
- [Agent Messaging - Semantic Search](/docs/guides/agent-messaging#semantic-search) - Search CLI messages with SimHash and neural embeddings
