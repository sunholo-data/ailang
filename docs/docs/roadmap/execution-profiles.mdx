...
**Design Document**: [execution-profiles.md](https://github.com/sunholo-data/ailang/blob/main/design_docs/planned/v0_6_0/execution-profiles.md)
...
- [Shared Semantic State](/docs/roadmap/shared-semantic-state) — Future multi-agent vision
