...
- [M-EFFECT-REPLAY-SUBSUMPTION: Validate-Path Effect-Mode Subsumption](https://github.com/sunholo-data/ailang/blob/dev/design_docs/planned/v1_0_0/m-effect-replay-subsumption.md)
...
- [M-NIGHTLY-FLAKE-GUARD: Variance Guard for the Nightly Eval Regression Detector](https://github.com/sunholo-data/ailang/blob/dev/design_docs/planned/v1_0_0/m-nightly-flake-guard.md)
...
- [M-EVAL-FMT-WEAKMODEL-AB — M5 (hard-set re-run) preregistration](https://github.com/sunholo-data/ailang/blob/dev/design_docs/planned/v0_31_0/m-eval-fmt-weakmodel-ab-M5-hardset-prereg.md)
- [M-EVAL-FMT-WEAKMODEL-AB — M5 (hard-set re-run) results](https://github.com/sunholo-data/ailang/blob/dev/design_docs/planned/v0_31_0/m-eval-fmt-weakmodel-ab-M5-hardset-results.md)
...
- [M-EVAL-TOKEN-HEADROOM: Equal Headroom, Visible Truncation, Labelled Thinking State](https://github.com/sunholo-data/ailang/blob/dev/design_docs/planned/v0_31_0/m-eval-token-headroom.md)
...
- [Sprint Plan — M-AI-REASONING-EFFORT](https://github.com/sunholo-data/ailang/blob/dev/design_docs/planned/v0_29_0/m-ai-reasoning-effort-sprint-plan.md)
