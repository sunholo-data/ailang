...
- [Sprint Plan — M-TAKE-FLATMAP-PEAK-MEMORY](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v1_1_0/m-take-flatmap-peak-memory-sprint-plan.md)
- [M-TAKE-FLATMAP-PEAK-MEMORY: `take(n, flatMap(f, xs))` Cannot Bound Peak Memory — Expose the Fused Primitive That Already Exists, Fix Its Latent Type Bug, and Teach the Trap](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v1_1_0/m-take-flatmap-peak-memory.md)
...
- [Sprint Plan: M-COMPILE-CACHE-UNVERIFIED-ARTIFACTS](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_35_2/m-compile-cache-unverified-artifacts-sprint-plan.md)
- [M-COMPILE-CACHE-UNVERIFIED-ARTIFACTS — bind executable cache artifacts to their authorizing key](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_35_2/m-compile-cache-unverified-artifacts.md)
- [Sprint Plan: M-PI-EVALUATOR-SESSION-HANDSHAKE](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_35_2/m-pi-evaluator-session-handshake-sprint-plan.md)
- [M-PI-EVALUATOR-SESSION-HANDSHAKE — satisfy the judge's local protocol before review](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_35_2/m-pi-evaluator-session-handshake.md)

## v0.35.1

- [Sprint plan: M-MOTOKO-SUITE-BOUND-DERIVATION](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_35_1/m-motoko-suite-bound-derivation-sprint-plan.md)
- [M-MOTOKO-SUITE-BOUND-DERIVATION: derive the suite's wall-clock and node-ceiling bounds from a stimulus measured in-test](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_35_1/m-motoko-suite-bound-derivation.md)

## v0.35.0

- [Sprint Plan: M-DX-PI-HARNESS — pi dev-harness extensions (Streams A+B)](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_35_0/m-dx-pi-harness-sprint-plan.md)
- [Sprint Plan: M-DX-PI-HARNESS-P2 — Distribution v2: ailang pi install](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_35_0/m-dx-pi-harness-sprint-plan2.md)
- [M-DX-PI-HARNESS — pi as a first-class development harness for AILANG (two streams)](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_35_0/m-dx-pi-harness.md)
- [Sprint Plan — M-FMT-PRINTER-LINE-WIDTH-LIMIT](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_35_0/m-fmt-printer-line-width-limit-sprint-plan.md)
- [M-FMT-PRINTER-LINE-WIDTH-LIMIT: A Width Predicate for the Printer's Existing Multi-Line Layouts, Then the Second Corpus Reformat](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_35_0/m-fmt-printer-line-width-limit.md)
- [Sprint Plan: M-MESSAGE-PLANE-FAIL-LOUD](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_35_0/m-message-plane-fail-loud-sprint-plan.md)
...
- [M-SPAWN-PIN-ENFORCEMENT — Deterministic role-spawn path enforcement for mission-control](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_35_0/m-spawn-pin-enforcement.md)

## v0.34.0

- [LC-1 `m-list-repr-spike` — M6 report: full matrix, kill-criterion arithmetic, and the programme verdict](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_34_0/m-list-repr-spike-M6-report.md)
- [M-OLLAMA-CLOUD-PROVIDER: Ollama Cloud as a Second Route for Open-Weight Models](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_34_0/m-ollama-cloud-provider.md)

## v0.33.4

- [Sprint Plan: Persistent Browser Auth Profiles](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_33_4/m-browser-auth-profiles-sprint-plan.md)
- [M-BROWSER-AUTH-PROFILES — persistent authenticated identity without password exposure](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_33_4/m-browser-auth-profiles.md)
- [Sprint Plan: M-STDLIB-FREEZE-GATE — Retire the Rotted Freeze Duplicate, Alias the Accepted Name to the Live Gate](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_33_4/m-stdlib-freeze-gate-path-mismatch-sprint-plan.md)
- [M-STDLIB-FREEZE-GATE-PATH-MISMATCH: Retire the Rotted Freeze Duplicate, Alias the Accepted Name to the Live Gate](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_33_4/m-stdlib-freeze-gate-path-mismatch.md)

## v0.33.3

- [Sprint Plan: Remote Browser Session Providers](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_33_3/m-remote-browser-session-providers-sprint-plan.md)
- [M-REMOTE-BROWSER-SESSION-PROVIDERS — provider-neutral browser sessions for local and cloud agents](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_33_3/m-remote-browser-session-providers.md)

## v0.33.2

- [HANDOVER — M-MISSION-LOOP-UNIFIED-TELEMETRY](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_33_2/HANDOVER-mission-loop-unified-telemetry.md)
- [Sprint Plan: M-MISSION-LOOP-UNIFIED-TELEMETRY](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_33_2/m-mission-loop-unified-telemetry-sprint-plan.md)
- [M-MISSION-LOOP-UNIFIED-TELEMETRY](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_33_2/m-mission-loop-unified-telemetry.md)

## v0.33.1

- [Sprint Plan: M-CI-FLAKE-SYSTEMIC-FIX](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_33_1/m-ci-flake-systemic-fix-sprint-plan.md)
- [M-CI-FLAKE-SYSTEMIC-FIX: One Gating Convention, Bounded Waits, a Default-Deny Egress Boundary, and a Known-Offender Lint for the Go Test Suite](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_33_1/m-ci-flake-systemic-fix.md)
- [Sprint Plan: M-OPENROUTER-BROADCAST-INGEST](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_33_1/m-openrouter-broadcast-ingest-sprint-plan.md)
- [M-OPENROUTER-BROADCAST-INGEST](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_33_1/m-openrouter-broadcast-ingest.md)
- [M-PARSER-RESERVED-KEYWORD-DIAGNOSTICS: catch `as`-as-identifier before it cascades](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_33_1/m-parser-reserved-keyword-diagnostics.md)

## v0.32.0

- [Sprint Plan: M-EVAL-STANDARD-CONFIDENCE-GATING](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_32_0/m-eval-standard-confidence-gating-sprint-plan.md)
- [M-EVAL-STANDARD-CONFIDENCE-GATING: ELO Confidence Gating for the Cloud Standard Release Baseline](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_32_0/m-eval-standard-confidence-gating.md)
- [M-FMT-DIALECT-ALIGNMENT](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_32_0/m-fmt-dialect-alignment.md)
- [PRE-READ: m-recorded-stream-api (ailang#546) — attended evaluation of the offered implementation](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_32_0/m-recorded-stream-api-preread.md)
- [Sprint Plan — M-RECORDED-STREAM-API (sprint 1 of 2)](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_32_0/m-recorded-stream-api-sprint-plan.md)
- [M-RECORDED-STREAM-API — Productionize the offered recorded `std/ai` stream](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_32_0/m-recorded-stream-api.md)
...
- [Sprint Plan: M-ANTHROPIC-CACHE-HIT-RATE](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_31_0/m-anthropic-cache-hit-rate-sprint-plan.md)
- [M-ANTHROPIC-CACHE-HIT-RATE: Close the prompt-cache gap on the `Generate` path](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_31_0/m-anthropic-cache-hit-rate.md)
...
- [M-EVAL-FMT-WEAKMODEL-AB — M5 (hard-set re-run) preregistration](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_31_0/m-eval-fmt-weakmodel-ab-M5-hardset-prereg.md)
- [M-EVAL-FMT-WEAKMODEL-AB — M5 (hard-set re-run) results](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_31_0/m-eval-fmt-weakmodel-ab-M5-hardset-results.md)
...
- [Sprint Plan: M-EVAL-MEASUREMENT-CONTRACT](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_31_0/m-eval-measurement-contract-sprint-plan.md)
- [M-EVAL-MEASUREMENT-CONTRACT: Distinguish "Measured Badly" from "Failed to Measure"](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_31_0/m-eval-measurement-contract.md)
- [M-EVAL-TOKEN-HEADROOM: Equal Headroom, Visible Truncation, Labelled Thinking State](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_31_0/m-eval-token-headroom.md)
- [Sprint Plan: M-MCP-EXACT-TOOL-SURFACE — Lane A](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_31_0/m-mcp-exact-tool-surface-lane-a-sprint-plan.md)
- [Sprint Plan — M-PROPERTY-GENERATOR-COVERAGE **Lane A only**](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_31_0/m-property-generator-coverage-lane-a-sprint-plan.md)
- [Sprint Plan — M-PROPERTY-GENERATOR-COVERAGE **Lane B1 only**](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_31_0/m-property-generator-coverage-lane-b1-sprint-plan.md)
- [M-PROPERTY-GENERATOR-COVERAGE: Vacuous-Pass Honesty + Structural Generator Derivation for Contract Property Tests](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_31_0/m-property-generator-coverage.md)
- [Sprint Plan: M-PROPERTY-TEST-TRUST (#547 + #535)](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_31_0/m-property-seed-determinism-sprint-plan.md)
- [M-PROPERTY-TEST-TRUST: Deterministic and Sound Contract Verdicts](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_31_0/m-property-seed-determinism.md)
- [Sprint Plan: M-Z3-ADT-RECORD-SORT — Declaration Closure Through Records + Honest `ai-check` Exit](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_31_0/m-z3-adt-record-sort-sprint-plan.md)
- [M-Z3-ADT-RECORD-SORT: Declare Reachable ADTs Through Records and Make `ai-check` Honest](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_31_0/m-z3-adt-record-sort.md)
- [Sprint Plan: M-Z3-HARD-TIMEOUT](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_31_0/m-z3-hard-timeout-sprint-plan.md)
...
- [Sprint Plan: M-DOCS-GATE-NOT-REQUIRED](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_30_0/m-docs-gate-not-required-sprint-plan.md)
...
- [M-EFFECT-REPLAY-SUBSUMPTION: Validate-Path Effect-Mode Subsumption](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_30_0/m-effect-replay-subsumption.md)
...
- [M-MISSION-ADAPTIVE-MULTIPROVIDER-ROUTING: the heterogeneous model fleet — quota-aware selection, design quorums, cross-provider executors, local-GPU lane](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_30_0/m-mission-adaptive-multiprovider-routing.md)
...
- [M-COORDINATOR-INBOX-WILDCARDS: glob-based inbox routing in the agent registry](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_29_0/m-coordinator-inbox-wildcards.md)
...
- [M-EVAL-RIG-RELIABILITY — post-mortem + remediation plan](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_29_0/m-eval-rig-reliability.md)
...
- [Sprint Plan: M-PKG-FEEDBACK-LOOP (Test + activate per-package feedback + macOS notifier)](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_29_0/m-pkg-feedback-loop-sprint-plan.md)
- [M-PKG-FEEDBACK-LOOP: Validate the per-package feedback loop end-to-end](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_29_0/m-pkg-feedback-loop.md)
...
- [Sprint Plan: M-RIG-RELIABILITY — make the rig catch breaks + measure docx](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_29_0/m-rig-reliability-sprint-plan.md)
...
- [m verify stdlib stale path](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_29_0/m-verify-stdlib-stale-path.md)
...
- [M-HOT-RELOAD: Hot Reload for serve-api](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_1/m-hot-reload-serve-api.md)
- [Sprint Plan: M-HOT-RELOAD - Hot Reload for serve-api](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_1/m-hot-reload-sprint-plan.md)
- [M-POLY-ADT: Polymorphic ADT Type Inference with Option](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_1/m-poly-adt-option-inference.md)
- [M-POLY-ADT Sprint Plan: Fix Polymorphic ADT Constructor Types](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_1/m-poly-adt-sprint-plan.md)
- [M-SERVE-API: Auto-Serve AILANG Exports as REST API](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_1/m-serve-api-react-frontend.md)
...
- [M-BUILTIN-SAFETY: Defensive Type Checking in Builtin Implementations](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-builtin-safety-type-checks.md)
- [M-CODEGEN-LIST-TYPE-DEFINITION: Fix Undefined List Type in Generated Code](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-codegen-list-type-definition.md)
- [M-CODEGEN-LIST-TYPE: Sprint Plan](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-codegen-list-type-sprint-plan.md)
- [M-COLLAB-PROVIDER-STATS Sprint Plan](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-collab-provider-stats-sprint-plan.md)
- [M-COLLAB-PROVIDER-STATS: Provider & Workspace Tags and Statistics for Collaboration Hub](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-collab-provider-stats.md)
- [M-CONTROL-PLANE-INTERACTIVE-FILTERING](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-control-plane-interactive-filtering.md)
- [Sprint Plan: M-CONTROL-PLANE-V4-INTEGRATION](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-control-plane-v4-integration-sprint-plan.md)
- [M-CONTROL-PLANE-V4-INTEGRATION: Unified Telemetry for Agent Monitoring](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-control-plane-v4-integration.md)
- [M-CONTROL-PLANE-V4: AILANG Operations Control Plane](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-control-plane-v4.md)
- [Sprint Plan: M-COORD-ARTIFACT-DISCOVERY](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-coord-artifact-discovery-sprint-plan.md)
- [M-COORD-ARTIFACT-DISCOVERY: Fix Coordinator Skill Invocation and Artifact Discovery](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-coord-artifact-discovery.md)
- [M-COORD-AUTO-REVISION: Automatic Agent Revision on GitHub Feedback](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-coord-auto-revision.md)
- [Sprint Plan: M-COORD-GENERIC-WORKFLOWS](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-coord-generic-workflows-sprint-plan.md)
- [M-COORD-GENERIC-WORKFLOWS: Configurable Agent Workflows](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-coord-generic-workflows.md)
- [M-COORD-HUMAN-LOOP Sprint Plan](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-coord-human-loop-sprint-plan.md)
- [M-COORD-HUMAN-LOOP: Human-in-the-Loop Coordinator Workflow](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-coord-human-loop.md)
- [Sprint Plan: M-COORD-TASKCHAIN-TESTS](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-coord-taskchain-tests-sprint-plan.md)
- [M-COORD-TASKCHAIN-TESTS: Add TaskChain Test Coverage](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-coord-taskchain-tests.md)
- [M-COORD-UI-APPROVALS: Dashboard Coordinator Approval Workflow](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-coord-ui-approvals.md)
- [M-COORDINATOR: Always-On Autonomous Development Daemon](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-coordinator-always-on-daemon.md)
- [M-COORDINATOR-TEST-WORKFLOW: Simple Coordinator Test File Creation](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-coordinator-test-workflow.md)
- [Sprint Plan: M-DASHBOARD-APPROVAL-INTEGRATION](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-dashboard-approval-integration-sprint-plan.md)
- [M-DASHBOARD-APPROVAL-INTEGRATION: Complete Dashboard Coordinator Approval Workflow](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-dashboard-approval-integration.md)
- [M-DASHBOARD-CLI: Dashboard API CLI Commands](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-dashboard-cli.md)
- [M-DASHBOARD-DOGFOODING: AILANG Dashboard Integration](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-dashboard-dogfooding.md)
...
- [M-GAP2: Fix Final Expression Lambda Arity Bug](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-gap2-lambda-arity-path-dependent-bug.md)
- [Sprint Plan: M-GAP2 Fix Path-Dependent Lambda Arity Bug](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-gap2-lambda-arity-sprint-plan.md)
- [Sprint Plan: M-GAP2 Final Expression Lambda Arity Bug](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-gap2-sprint-plan.md)
- [Sprint Plan: M-GAP4 - Record Width Subtyping via Row Polymorphism](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-gap4-record-width-subtyping-sprint.md)
- [M-GAP4: Record Width Subtyping via Row Polymorphism](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-gap4-record-width-subtyping.md)
- [Sprint Plan: M-GAP5 - Add `repeat` to std/string](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-gap5-stdlib-repeat-sprint-plan.md)
- [M-GAP5: Add `repeat` to std/string](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-gap5-stdlib-repeat.md)
- [Sprint Plan: M-GAP6 - Add maximum/minimum to std/list](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-gap6-stdlib-maximum-sprint-plan.md)
- [M-GAP6: Add `maximum` and `minimum` to std/list](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-gap6-stdlib-maximum.md)
- [M-GENERIC-PIPELINE: Config-Driven Agent Pipelines](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-generic-pipeline.md)
- [Sprint Plan: M-JSON-HELPERS](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-json-helpers-sprint-plan.md)
- [M-JSON-HELPERS: Convenience Functions for JSON Access](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-json-helpers.md)
- [Sprint Plan: M-MSG-ROUTING - Message Routing DX Improvements](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-msg-routing-sprint-plan.md)
- [Sprint Plan: M-OPENAI-RESPONSES-API Completion](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-openai-responses-api-completion-sprint.md)
- [Sprint Plan: M-OPENAI-RESPONSES-API](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-openai-responses-api-sprint.md)
- [M-OPENAI-RESPONSES-API: OpenAI Responses API & Agent Module](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-openai-responses-api.md)
- [M-OTEL-CROSS-PROCESS: Cross-Process Trace Linking](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-otel-cross-process-linking.md)
- [Sprint Plan: M-OTEL-CROSS-PROCESS](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-otel-cross-process-sprint-plan.md)
- [M-OTEL-DASHBOARD Implementation Report](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-otel-dashboard.md)
- [Sprint Plan: M-OTEL-ENHANCED-TRACING-DX](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-otel-enhanced-tracing-dx-sprint-plan.md)
- [M-OTEL-ENHANCED-TRACING-DX: Human-Friendly Tracing for Debugging](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-otel-enhanced-tracing-dx.md)
- [M-OTEL-EXTENDED: Extended OpenTelemetry Instrumentation](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-otel-extended-instrumentation.md)
- [M-OTEL-EXTENDED Sprint Plan](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-otel-extended-sprint-plan.md)
- [Parser Infinite Loop Guard](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-parser-infinite-loop-guard.md)
- [Sprint Plan: M-PARSER-LOOP - Parser Infinite Loop Guard](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-parser-loop-sprint-plan.md)
- [Sprint Plan: M-POLY-ARITH - Fix Polymorphic Arithmetic Operators](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-poly-arithmetic-fix-sprint-plan.md)
- [M-POLY-ARITH: Fix Polymorphic Arithmetic Operators in Lambdas](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-poly-arithmetic-fix.md)
- [M-SCRIPT-INVOKE Sprint Plan](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-script-invoke-sprint-plan.md)
- [M-SCRIPT-INVOKE: Deterministic Script Execution for Agent Workflows](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-script-invoke.md)
- [M-SESSION-WORKSPACE: Claude Code Rich Telemetry via Hooks](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-session-workspace-hooks.md)
- [Sprint Plan: M-STDLIB-DATETIME](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-stdlib-datetime-sprint-plan.md)
- [M-STDLIB-DATETIME: Date and Time Standard Library](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-stdlib-datetime.md)
- [Sprint Plan: String Reverse Builtin (`_string_reverse`)](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-string-reverse-sprint-plan.md)
- [String Reverse Builtin (`_string_reverse`)](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-string-reverse.md)
- [M-TASK-HIERARCHY Follow-ups](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-task-hierarchy-followups.md)
- [M-TASK-HIERARCHY: Task-to-Trace Linking](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-task-hierarchy-linking.md)
- [M-TASK-HIERARCHY Sprint Plan](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_7_0/m-task-hierarchy-sprint-plan.md)
...
- [DX-15: Shared Memory + Near-Duplicate Caching MVP](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/DX-15-semantic-caching-MVP.md)
- [DX-16: SharedIndex — Deterministic Semantic Retrieval for SharedMem](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/dx-16-shared-index-deterministic-retrieval.md)
- [Sprint Completion Report: DX-16 SharedIndex — Deterministic Semantic Retrieval](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/dx-16-sprint-completion-report.md)
- [DX-17: TList/TApp Type Unification - Sprint Plan](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/dx-17-sprint-plan.md)
- [DX-17: TList/TApp Type Unification Bug (Phase 1)](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/dx-17-tlist-tapp-unification.md)
- [M-CODEGEN-UNIFIED-SLICE-CONVERTERS: Complete Typed Slice Conversion](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/m-codegen-unified-slice-converters.md)
- [M-DOC-SEM: Lazy Embeddings for Neural Doc Search](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/m-doc-sem-lazy-embeddings.md)
- [Sprint Plan: M-DOC-SEM Lazy Embeddings for Neural Doc Search](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/m-doc-sem-sprint-plan.md)
- [M-DOCS-ACCURACY: Website Documentation Accuracy Update](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/m-docs-accuracy-website-update.md)
- [Sprint Plan: M-DX11-DEBUG-TYPES-CLI (Type Inference Debug CLI)](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/m-dx11-debug-types-cli-sprint-plan.md)
- [M-DX11-DEBUG-TYPES-CLI: Type Inference Debug CLI](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/m-dx11-debug-types-cli.md)
- [Sprint Plan: M-DX11-TYPE-PROVENANCE](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/m-dx11-type-provenance-sprint-plan.md)
- [M-DX11-TYPE-PROVENANCE: Type Origin Tracking](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/m-dx11-type-provenance.md)
- [M-DX27: Fix Invalid Bool Type Assertion in Nested Match](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/m-dx27-bool-match-type-assertion.md)
- [M-DX29: Fix Nested ADT Type in Option Pattern Match](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/m-dx29-option-nested-adt-type.md)
- [M-DX30: Add Missing EqString Runtime Helper](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/m-dx30-eqstring-runtime.md)
- [M-JSON-ACCESSORS: Enable JSON Accessor Functions](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/m-json-accessors-enabled.md)
- [M-MSG-SEMANTIC: Semantic Search + Safe Deduplication for AILANG Messages](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/m-msg-semantic-caching.md)
- [M-MSG-SEMANTIC Sprint Plan: Semantic Search for AILANG Messages](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/m-msg-semantic-sprint-plan.md)
- [M-RT1: List Pattern Match Return Value Bug](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_6_0/m-rt1-list-pattern-return-bug.md)
...
- [Codegen Bug Pattern Analysis: v0.5.10](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_10/codegen-bug-pattern-analysis.md)
- [M-CODEGEN-ADT-TYPE-ASSERT: Fix Invalid Type Assertions on ADT Constructor Results](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_10/m-codegen-adt-type-assert.md)
- [M-CODEGEN-CROSS-MODULE: Cross-Module Function Calls Use _impl](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_10/m-codegen-cross-module-impl.md)
- [M-CODEGEN-LIST: Flatten List Literals and Bool Matches](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_10/m-codegen-list-flatten.md)
- [Sprint Plan: M-CODEGEN-LIST - Flatten List Literals and Bool Matches](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_10/m-codegen-list-sprint-plan.md)
- [M-CODEGEN-NESTED-RECORD-TYPE: Fix Nested Record Type Selection](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_10/m-codegen-nested-record-type.md)
- [M-CODEGEN-RECORD-TYPENAME-PRESERVATION: Fix TypeName Loss During Substitution](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_10/m-codegen-record-typename-preservation.md)
- [M-CODEGEN-TUPLE: Tuple Pattern Matching in Go Codegen](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_10/m-codegen-tuple-pattern.md)
- [M-CROSS-MODULE-RECORD-UNIFICATION: Fix Type Unification for Cross-Module Nested Record Fields](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_10/m-cross-module-record-unification.md)
- [Sprint Plan: M-DX11-CYCLES (Type Graph Cycle Detection)](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_10/m-dx11-cycles-sprint-plan.md)
- [M-DX11-CYCLES: Type Graph Cycle Detection Command](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_10/m-dx11-cycles.md)
- [M-DX11: Type Inference Debugging Tools](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_10/m-dx11-type-inference-debugging.md)
- [Sprint Plan: M-DX11-TYPE-REPORT (Type Inference Debug Primitive)](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_10/m-dx11-type-report-sprint-plan.md)
- [M-FIX-FLOAT-OP: Float Operator Dispatch in Pure Functions](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_10/m-fix-float-operator-dispatch.md)
- [Fix Type Application in Return Type Annotations (Option[T])](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_10/m-fix-option-type-annotation.md)
- [String Conversion Functions (floatToStr, intToStr)](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_10/m-string-conversion.md)
- [M-UNIFIED-AI-PROVIDERS: Unified AI Provider Architecture](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_10/m-unified-ai-providers.md)
- [Sprint Plan: M-UNIFIED-AI-PROVIDERS](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_10/sprint-unified-ai-providers.md)

## v0.5.9

- [M-CODEGEN-FLAT-IF-ELSE: Flatten Nested Closure Chains in If-Else Codegen](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_9/m-codegen-flat-if-else.md)
- [M-CODEGEN: Array Runtime Typed Slice Support](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_9/m-codegen-getopt-typed-slices.md)
- [M-CODEGEN-OPTION-RUNTIME-HELPERS: Fix GetOpt to Return *Option Instead of Map](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_9/m-codegen-option-runtime-helpers.md)
- [M-CODEGEN-POINTER-RETURN-TYPES: Fix Type Assertion Failures for Record Returns](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_9/m-codegen-pointer-return-types.md)
- [M-CODEGEN-STDLIB-MATH: Go Codegen Missing std/math Function Definitions](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_9/m-codegen-stdlib-math.md)
- [M-CODEGEN-V2: Flat Go Code Generation](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_9/m-codegen-v2-flat-output.md)
- [Sprint Plan: M-CODEGEN-V2 - Flat Go Code Generation](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_9/m-codegen-v2-sprint-plan.md)
- [M-DX11: Cyclic Type Diagnostics & Hang Prevention](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_9/m-dx11-cyclic-type-diagnostics.md)
- [Sprint Plan: M-DX11 Cyclic Type Diagnostics](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_9/m-dx11-sprint-plan.md)
- [Sprint Plan: M-DX11-TRAVERSE - Safe Type Traversal Library](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_9/m-dx11-traverse-sprint.md)
- [M-DX11-TRAVERSE: Safe Type Traversal Library](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_9/m-dx11-traverse.md)
- [M-FIX-FLOAT-OP: Complete Fix Summary](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_9/m-fix-float-op-summary.md)
- [M-FIX-IF-ELSE-LET: Better Error for Let in If-Else Branches](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_9/m-fix-if-else-let-block.md)
- [M-FIX-NESTED-RECORD-LIST: Nested Record List Type Inference Bug](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_9/m-fix-nested-record-list.md)
- [M-MSG-GITHUB: GitHub Issues Backend for Messaging System](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_9/m-msg-github-issues-backend.md)
- [Sprint Plan: M-MSG-GITHUB - GitHub Issues Backend](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_9/m-msg-github-sprint-plan.md)

## v0.5.8

- [Sprint Plan: M-BUGFIX v0.5.8 Bug Fix Sprint](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_8/m-bugfix-sprint-plan.md)
- [M-CODEGEN-BLANK: Fix Blank Identifier and Return Type Codegen Bugs](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_8/m-codegen-blank-identifier.md)
- [M-CODEGEN-BOOL-SLICE: Add Bool Slice Converter](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_8/m-codegen-bool-slice.md)
- [M-CODEGEN-LIST-CONCAT: Add List Concatenation Runtime Helper](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_8/m-codegen-list-concat.md)
- [M-CODEGEN-TYPE-ASSERTIONS: Fix _impl Functions Calling Typed Exports](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_8/m-codegen-type-assertions.md)
- [M-CODEGEN-TYPED-PARAMS: Fix Typed Parameters Becoming interface{}](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_8/m-codegen-typed-params.md)
- [M-CODEGEN-ZERO-ARG: Fix Zero-Arg Function Code Generation](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_8/m-codegen-zero-arg.md)
- [M-PERF1: Effect Checker Performance for Large Array Literals](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_8/m-perf1-effect-checker-large-arrays.md)
- [M-PERF2: Cyclic Type Traversal Hang - Post-Mortem Analysis](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_8/m-perf2-cyclic-type-hang-postmortem.md)
- [M-PERF2: Operator Lowering Hang on Complex Modules](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_8/m-perf2-operator-lowering-hang.md)
- [M-TYPE-ALIAS: Type Alias Expansion in ADT Variant Parameters](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_8/m-type-alias-unification.md)

## v0.5.7

- [M-CODEGEN-TYPED-SLICES: Runtime List Functions for Typed Slices](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_7/m-codegen-typed-slices.md)
- [M-DX11: Better Stdlib Discovery for AI Agents](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_7/m-dx11-stdlib-discovery.md)
- [typesIdentical Performance Bug (Large Records)](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_7/types-identical-performance.md)

## v0.5.6

- [M-EVAL-GUARD: Eval Process Guardrails & Orphan Detection](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_6/m-eval-process-guardrails.md)
- [M-MSG: Agent Messaging System Improvements](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_6/m-msg-agent-messaging-improvements.md)
- [M-MSG Sprint Plan: Agent Messaging System Rewrite](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_6/m-msg-sprint-plan.md)
- [M-TYPE1: Array/TArray Type Unification Bug](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_6/m-type1-array-tarray-unification.md)
- [M-TYPE1 Sprint Plan: Array/TArray Type Unification Bug Fix](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_6/m-type1-sprint-plan.md)

## v0.5.5

- [M-DX23: Typed Function Signatures](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_5/m-dx23-typed-function-signatures.md)
- [M-DX24: Typed Function Bodies](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_5/m-dx24-typed-function-bodies.md)
- [M-DX25: Typed Let Bindings](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_5/m-dx25-typed-let-bindings.md)
- [M-DX26: Typed Wrapper Architecture](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_5/m-dx26-typed-wrapper-architecture.md)

## v0.5.4

- [M-DX17: Integer Literals Generated as int Instead of int64](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_4/m-dx17-int-literals-int64.md)
- [M-DX18: RecordAccess Uses Map Syntax on Typed Structs](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_4/m-dx18-recordaccess-typed-structs.md)
- [M-DX22: Auto-Generate ADT Slice Converters](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_4/m-dx22-adt-slice-converters.md)

## v0.5.3

- [M-DX11: Named ADT Constructor Fields for Go Codegen](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_3/m-dx11-named-adt-fields.md)
- [Sprint Plan: M-DX11 Relaxed Module Matching](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_3/m-dx11-sprint-plan.md)
- [Sprint Plan: M-DX12 Typed World Boundary Marshalling](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_3/m-dx12-sprint-plan.md)
- [M-DX12: Typed World Boundary Marshalling](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_3/m-dx12-typed-adt-slices.md)

## v0.5.2

- [M-DX11: Relaxed Module Matching](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_2/m-dx11-relaxed-module-matching.md)
- [M-GAME-B Phase 2: Complete Go Codegen for Game Modules](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_2/m-game-b-phase2-go-codegen-SUPERSEDED.md)
- [M-GAME-B Phase 2 Sprint Plan](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_2/m-game-b-phase2-sprint-plan.md)
...
- [M-GAME-D: Sim Example & Integration](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_5_0/M-GAME-D-sim-example.md)
...
- [Sprint Plan: M-BUG-LOCAL-IMPORTS - Fix Local Module Import Resolution](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_4_8/m-bug-local-imports-sprint-plan.md)
- [M-BUG-LOCAL-IMPORTS: Fix Local Module Import Resolution](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_4_8/m-bug-local-imports.md)
- [Sprint Plan: M-BUG-RECORD-UPDATE-INFERENCE](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_4_8/m-bug-record-update-inference-sprint-plan.md)
- [M-BUG-RECORD-UPDATE-INFERENCE: Fix Record Update Type Inference](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_4_8/m-bug-record-update-inference.md)
- [Sprint Plan: M-BUG-RECURSION-DEPTH](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_4_8/m-bug-recursion-depth-sprint-plan.md)
- [M-BUG-RECURSION-DEPTH: Fix Unexpected Recursion Depth Overflow](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_4_8/m-bug-recursion-depth.md)
- [M-IMPORT-ALIASING: Module and Symbol Aliasing](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_4_8/m-import-aliasing.md)

## v0.4.7

- [Core Program Evaluation for Inline Tests](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_4_7/m-testing-inline-core-evaluation.md)
- [M-TESTING-INLINE: Core Evaluation Fix - Sprint Plan](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_4_7/m-testing-inline-sprint-plan.md)
...
- [monomorphization](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_4_0/monomorphization.md)

## v0.3.25

- [M-BUG: stdlib uses reserved keyword `exists` as function name](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_3_25/m-bug-stdlib-reserved-keyword.md)

## v0.3.23

- [M-JSON-ENCODE: Implement Missing JSON Encode Builtin](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_3_23/M-JSON-ENCODE-BUILTIN.md)
- [M-JSON-ENCODE Sprint Plan](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_3_23/M-JSON-ENCODE-sprint-plan.md)

## v0.3.22

- [Sprint Plan: M-EVAL-HTTP - Fix HTTP/JSON Syntax Errors (75% AILANG Failure Rate)](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_3_22/M-EVAL-HTTP-FIX-sprint-plan.md)

## v0.3.20

- [M-CLAUDE-CODE-HEADLESS Sprint Plan](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_3_20/M-CLAUDE-CODE-HEADLESS-sprint-plan.md)
- [M-CLAUDE-CODE-INTEGRATION: Hooks & Inbox (Phases 1-2)](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_3_20/M-CLAUDE-CODE-INTEGRATION-HOOKS.md)
- [M-CLAUDE-CODE-INTEGRATION: Document Split](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_3_20/M-CLAUDE-CODE-INTEGRATION.md)
...
- [AILANG: Compilation Failures](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_3_17/20251022_compile_error_ailang_compilation_failures.md)
- [Sprint Plan: M-COMPILE-ERROR - Enhanced Error Messages for AI Code Generation](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_3_17/M-COMPILE-ERROR-SPRINT.md)
...
- [M-DX9: Parser Developer Experience Improvements](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_3_15/m-dx9-parser-developer-experience.md)
...
- [AI Agent Calls: HTTP Headers + JSON Support](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_3_9/20251015_ai_agent_calls.md)
- [M-JSON: JSON Convenience Builders](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_3_9/m-json-convenience-builders.md)
...
- [AI Usability Assessment: Is AILANG "The Language AIs Prefer"?](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_3_5/ai_usability_assessment.md)
- [v0.3.5: Functional Completeness Sprint](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_3_5/v0_3_5_functional_completeness.md)

## v0.3.2

- [3 2 roadmap](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_3_2/3_2_roadmap.md)
- [design 3 2](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_3_2/design_3_2.md)
- [AILANG v3.2 Phase 1 Implementation Report](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_3_2/implementation_report.md)
...
- [Function Body Block Expressions](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_0_12/function_body_blocks.md)

## v0.0.4

- [AILANG v0.0.4 Implementation Report](https://github.com/sunholo-data/ailang/blob/dev/design_docs/implemented/v0_0_4/V0_0_4_IMPLEMENTATION_REPORT.md)
