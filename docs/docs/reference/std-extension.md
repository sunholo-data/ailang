...
- [v0.19.0 / v0.19.1 changelog entries](https://github.com/sunholo-data/ailang/blob/dev/changelogs/v0.18-v0.25-eval-harness.md) — full release notes including the M-EXT-PORTABILITY-GATE chain.
