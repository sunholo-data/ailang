...
- [`std/extension.requireWorkdirFile`](./language-syntax) — companion helper for extensions whose assets live in the consumer's workdir rather than the package itself.
