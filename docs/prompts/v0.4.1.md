...
# AILANG v0.4.1 - AI Teaching Prompt (JSON Decode + Environment Variables + Net Effects)
...
Modules, functions, lambdas, pattern matching, ADTs, records, effects (`! {IO, FS, Net, Env}`), recursion, numeric conversions, HTTP with headers, **JSON encoding/decoding**, **property-based testing**, **environment variables**.
