---
layout: page
title: AI Prompt - v0.3.19
parent: AI Prompts
nav_order: 1
---

# AILANG v0.3.19 - AI Teaching Prompt
...
Modules, functions, lambdas, pattern matching, ADTs, records, effects (`! {IO, FS, Net}`), recursion, numeric conversions, HTTP with headers, JSON encoding.
