...
![Examples](https://img.shields.io/badge/examples-93%20passing%205%20failing-green.svg)
![License](https://img.shields.io/badge/license-Apache%202.0-green.svg)

**93/98 examples passing (95%)** | [Full status](https://ailang.sunholo.com/docs/examples)
<!-- EXAMPLES_STATUS_END -->
