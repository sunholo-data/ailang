...
![Coverage](https://img.shields.io/badge/coverage-36.9%25-orange.svg)
...
## 🧪 Current Milestone: v0.3.22 (JSON Encoding Support)

- ✅ Complete JSON encoding implementation (`_json_encode` builtin)
- ✅ RFC 8259 compliant string escaping
- ✅ Uncommented `encode()` function in std/json.ail
- ✅ 27 comprehensive tests (unit + roundtrip)
- ✅ Unblocks api_call_json benchmark (no more IMP010 errors)
- ✅ All **137 tests passing** (27 new JSON encode tests)
- 🔜 **Next**: Deterministic tooling (normalize, suggest-imports) in v0.3.23

### Major Milestones

- **v0.3.22 (Oct 2025)**: M-JSON-ENCODE - JSON encoding support for HTTP POST workflows
- **v0.3.21 (Oct 2025)**: Parser regression fixes for nested match expressions in blocks
