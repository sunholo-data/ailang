...
![Examples](https://img.shields.io/badge/examples-86%20passing%2012%20failing-green.svg)
![License](https://img.shields.io/badge/license-Apache%202.0-green.svg)

**86/98 examples passing (88%)** | [Full status](https://ailang.sunholo.com/docs/examples)
<!-- EXAMPLES_STATUS_END -->
