...
## 🧪 Current Milestone: v0.3.19 (Code Organization & AI Maintainability)

- ✅ Pipeline refactoring: 2 large files → 10 focused modules (all <800 lines)
- ✅ AI-friendly file sizes: `pipeline.go` (1014→121 lines), `specialize.go` (1384→142 lines)
- ✅ Enhanced package documentation with clear file responsibilities
- ✅ All **2,847+ tests passing**; 100% of examples passing
- 🔜 **Next**: Deterministic tooling (normalize, suggest-imports) in v0.3.20
...
![Examples](https://img.shields.io/badge/examples-27%20passing%201%20failing-green.svg)

**27/28 examples passing (96%)** - Each example exercises specific language features, so this directly reflects implementation completeness.
...
| `runnable/json_basic_decode.ail` | ❌ Fail | Warning: import path 'stdlib/std/*' is deprecat... |
