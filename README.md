...
![Examples](https://img.shields.io/badge/examples-94%20passing%204%20failing-green.svg)
![License](https://img.shields.io/badge/license-Apache%202.0-green.svg)

**94/98 examples passing (96%)** | [Full status](https://ailang.sunholo.com/docs/examples)
<!-- EXAMPLES_STATUS_END -->
