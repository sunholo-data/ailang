# M-PKG-RESOLVER-DIRECT-WINS: Version Conflict Detection in Dependency Resolver

**Status**: Implemented (conflict detection + deterministic iteration)
**Implemented**: v0.9.11 (commit 1cd08456, 2026-03-24)
**Original Target**: v0.10.0
**Follow-up**: [m-pkg-upgrade-chain-tooling.md](../../planned/v0_10_0/m-pkg-upgrade-chain-tooling.md) — upgrade workflow tooling (planned)

**Design Decision (2026-03-24):** Root direct deps do NOT silently override incompatible transitive deps. Published package dependency contracts are inviolable. The resolver fails with structured conflicts; better upgrade tooling addresses the DX pain. See follow-up design doc.
