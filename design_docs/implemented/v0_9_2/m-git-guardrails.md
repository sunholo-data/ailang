...
- [design_docs/implemented/v0_38_0/m-process-subcmd-allowlist.md](design_docs/implemented/v0_38_0/m-process-subcmd-allowlist.md) — Similar pattern: constraining what commands agents can execute
