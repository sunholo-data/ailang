...
**[NEXT] m-changelog-gate-deltas — fold the three arms `#758` had and `#759` lacks into the
landed gate.** Iteration 217 closed motoko's `#758` as superseded under `c2022c7fa`'s ownership
