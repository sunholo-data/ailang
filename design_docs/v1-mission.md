...
- **[FIRE NEXT ITERATION — D-26, Mark attended 2026-08-22]** M4b baseline cohort run: the
  ~2026-08-01 quota-reset gate has passed; the $20-total-cap approval (2026-07-27) stands;
  outranks the queue next iteration under D-28 (raise `MISSION_METERED_BUDGET_USD` to 20 for that
  single iteration if needed).
