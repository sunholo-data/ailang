...
**[NEXT] [iter-295, from Mark's 2026-08-27 re-queue directive — the re-plan's ONLY genuine residue] m-openrouter-session-chain-registration**
...
**[QUEUED — was [NEXT]; demoted one place by iter-295 so exactly one row carries [NEXT]] [iter-293, decision ANSWERED — design already written] m-prompt-freeze-mirror-all-versions**
