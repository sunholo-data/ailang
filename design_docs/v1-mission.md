...
**[IN-SPRINT &mdash; iter-314: Sprint 1 **M1+M2+M3+M4 LANDED**; **M5 remains (~1d)**] `m-registry-interface-hash-blind-to-signatures` &mdash; a BREAKING API change is classified `patch` to every downstream consumer.**
