...
- **Effect sprints** (decomposed): **m-effect-replay-contracts (2/4, 3d) [LANDED PARTIAL iter-99 →
  ...
  **m-effect-replay-subsumption [NEW GATING clause-4, PARKED needs-human-review iter-99 — a Mark/type-system
...
- **m-bytecode-vm-parity-bugs** (bytecode-VM vs eval output divergences) **[RE-SCOPED + Lane-B PARKED
  ...
  **Lane B (PARKED-for-Mark (h))**: `recursion_quicksort` (VM **silently returns `[3]`** — soundness)
