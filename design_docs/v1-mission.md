...
- **DX tooling** (Mark: both in → resolved 2026-07-18: M-TOOLING-DETERMINISTIC **CLOSED-SUPERSEDED**
  ...
  **m-ailang-fmt-adoption [UNBLOCKED 2026-07-19 (iter 63) — its gate (phase2) has LANDED; SIGKILL-escalation fix APPROVED by Mark; ready for planning next fmt iteration. Was: DOC CREATED + QUORUM-BLOCKED ×3 → PARKED; Rev-3 iter 60]**
