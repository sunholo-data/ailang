...
**[NEXT] [FIVE FINDINGS FROM THE ITER-326 JUDGE, ALL NON-BLOCKING, ALL MEASURED — bundle them, none is worth an iteration alone] `m-autopush-gate-followups` — the committed-Go formatting gate on the dev auto-push works, and here is everything it does not cover.**
