...
**[NEXT — 4 of 15 dispositioned; 11 remain] m-sweep-orphans-2026-08-17 — the zero-mention issues from
...
- **Language / stdlib** — `#688` (String primitives: `charAt` O(i), `find` has no offset →
  per-character scanners quadratic or 5× slow), `#689` (`ailang verify`: SMT sort mismatch on a
