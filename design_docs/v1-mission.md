...
- **[NEXT — now the QUEUE HEAD: m-planner-codex-lane LANDED at iter-136, so this moves up.
  ...
  m-mcp-exact-tool-surface LANE B** (NEW-DOC needed, quorum required; P2→**P1 by directive** —
