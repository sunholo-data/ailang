...
**0a. [IN-SPRINT — M1 LANDED `d54672b85` (iter 266; independent `sonnet` evaluator PASS 95/100, generator≠judge; PR #848, non-closing; four-park streak was Anthropic-outage, not the item). M2 (rewire `serveapi`, evict machinery, delete the transitional shim) is next — P1, cross-mission blocker, `D-33`] `#764` — a protocol-only serveapi module**
