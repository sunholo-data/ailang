...
**Acceptance criteria:**
- [ ] install → files in ~/.pi/agent/extensions + manifest; re-run idempotent
- [ ] user-modified managed file → .ailang-suggested/ copy + warning, original preserved
- [ ] uninstall removes only managed files
- [ ] status reports FRESH/DRIFT/UNMANAGED/MISSING per file
...
**Acceptance criteria:**
- [ ] make pi-assets idempotent; verify-pi-assets catches a seeded drift
...
**Acceptance criteria:**
- [ ] Dockerfile change present (image rebuild/publish stays human-owned)
- [ ] README distribution guide rewritten around the binary channel
- [ ] CHANGELOG entry
