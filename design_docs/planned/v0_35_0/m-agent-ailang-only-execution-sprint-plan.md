...
### M1 — Bank the policy before changing it (~2h, ~70 LOC)
...
### M2 — One gate: `ailang run --policy` (~5h, ~180 LOC)
...
### M3 — One tool: `ailang-exec.ts` (~4h, ~150 LOC TS + probe)
...
### M4 — One field: `tool_policy` (~4h, ~140 LOC)
...
### M5 — Resident cutover, eval lane, boundary (~5h)
