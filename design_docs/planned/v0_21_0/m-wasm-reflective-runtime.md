...
|-------|-------|--------|----------|--------|
| **[M-COG-RUNTIME](./m-cog-runtime.md)** | Effects + Message Fabric + Event Log + Deterministic Scheduler (Go-side substrate) | v0.21.x | ~105h | **✅ Shipped** (13 commits, ~6,765 LOC on `dev`) |
